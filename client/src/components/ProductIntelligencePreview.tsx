...
@keyframes gold-glow-pulse {
  0%, 100% { box-shadow: 0 0 60px rgba(59,130,246,0.05); }
  50%       { box-shadow: 0 0 80px rgba(59,130,246,0.09); }
}
...
function SkeletonRow({ isFirst }: { isFirst?: boolean }) {
  return (
    <div style={{
      ...
      alignItems: 'center',
      background: isFirst ? 'rgba(59,130,246,0.02)' : 'transparent',
    }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 28, flexWrap: 'wrap', gap: 16 }}>
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <h2 style={{
                  ...
                  Find your next{' '}
                  <span style={{
                    background: 'linear-gradient(135deg, #3B82F6, #f0c840)',
              ...
              <div style={{
                  ...
                  <div key={product.rank}>
                    ...
                    <div
                      ...
                      style={{
                        ...
                        borderBottom: '1px solid #F9FAFB',
                        alignItems: 'center',
                        background: product.rank === 1 ? 'rgba(59,130,246,0.04)' : 'transparent',
                        position: 'relative',
                    ...
                    >
                      ...
                      <span style={{
                        ...
                        fontSize: 12,
                        color: product.rank === 1 ? '#3B82F6' : '#4b5563',
                        fontWeight: 600,
                      }}>
                        {product.rank}
                      </span>
                      ...
                      <div className={`pip-detail-panel${showDetail ? ' open' : ''}`}>
                        <div style={{
                          ...
                          <div style={{ marginBottom: 8 }}>
                            <span style={{ color: '#3B82F6', fontWeight: 700 }}>💡 Why it's winning:</span>{' '}
                ...
                <div style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, pointerEvents: 'auto' }}>
                    ...
                    <span style={{ color: '#3B82F6', fontFamily: 'DM Sans, sans-serif', fontSize: 13, fontWeight: 600 }}>
              ...
              {loading ? (
                ...
                <div style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
                    <span style={{ fontFamily: "'Bricolage Grotesque', sans-serif", fontSize: 24, fontWeight: 800, color: '#3B82F6' }}>
                      {first.revenue}
                    </span>
