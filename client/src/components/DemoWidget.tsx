...
@keyframes border-breathe {
  0%, 100% { box-shadow: 0 0 40px rgba(79,142,247,0.08); }
  50%       { box-shadow: 0 0 60px rgba(79,142,247,0.16); }
}
        ...
        >
          ...
          <div
            style={{
              ...
              textShadow: '0 0 10px rgba(79,142,247,0.5)',
            }}
          >
            Majorka AI
          </div>
          ...
          {PROMPTS.map((_, i) => (
            <div
              ...
              style={{
                ...
                height: 6,
                borderRadius: 3,
                background: i === promptIdx ? '#4f8ef7' : '#F0F0F0',
