    ...
    <>
      ...
      <div style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 24 }}>
          {REGION_LIST.map(r => (
            <button
              ...
              style={{
                padding: '14px 16px', background: selected === r.code ? 'rgba(79,142,247,0.08)' : '#FAFAFA',
                border: `2px solid ${selected === r.code ? '#4f8ef7' : '#E5E7EB'}`,
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                <div>
                  <div style={{ fontSize: 13, fontWeight: 700, color: selected === r.code ? '#4f8ef7' : '#0A0A0A' }}>{r.name}</div>
        ...
        <button onClick={handleConfirm}
          style={{
            width: '100%', height: 48, background: '#4f8ef7', color: 'white',
