...
function ConfettiBurst() {
  ...
  const colors = ['#d4af37', '#10b981', '#3b82f6', '#f59e0b', '#ec4899', '#d4af37'];
  return (
    <div
                        ...
                        background:
                          col.key === 'done'
                            ...
                            : col.key === 'inprogress'
                              ...
                              : '#FAFAFA',
                        border: `1px solid ${col.key === 'done' ? 'rgba(16,185,129,0.18)' : col.key === 'inprogress' ? 'rgba(212,175,55,0.18)' : '#F9FAFB'}`,
                        borderRadius: 8,
                        padding: '8px 10px',
                        cursor: 'pointer',
                        userSelect: 'none',
                      ...
                      {col.key !== 'done' && (
                        <button
                          ...
                          style={{
                            ...
                            fontSize: 10,
                            fontWeight: 600,
                            color: col.key === 'inprogress' ? '#d4af37' : '#9CA3AF',
                            background: 'none',
                            border: 'none',
                            cursor: 'pointer',
                            padding: 0,
