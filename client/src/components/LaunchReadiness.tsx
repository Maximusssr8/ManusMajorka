...
function ProgressDial({ percent, allDone }: { percent: number; allDone: boolean }) {
  ...
  const color = allDone ? '#10b981' : percent > 60 ? '#4f8ef7' : '#4f8ef7';
...
function ConfettiBurst() {
  ...
  const colors = ['#4f8ef7', '#10b981', '#3b82f6', '#f59e0b', '#ec4899', '#4f8ef7'];
  return (
    <div
...
const COLUMNS: { key: ColKey; label: string; color: string }[] = [
  ...
  { key: 'inprogress', label: 'In Progress', color: '#4f8ef7' },
...
export default function LaunchReadiness({ userId }: LaunchReadinessProps = {}) {
  ...
  return (
    <div
      ...
      style={{
        background: allDone ? 'rgba(16,185,129,0.04)' : 'rgba(79,142,247,0.02)',
        border: `1px solid ${allDone ? 'rgba(16,185,129,0.2)' : 'rgba(79,142,247,0.12)'}`,
        borderRadius: 16,
        padding: '20px 20px',
        marginBottom: 24,
        position: 'relative',
    ...
    >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, flex: 1 }}>
          <Rocket size={16} style={{ color: allDone ? '#10b981' : '#4f8ef7', flexShrink: 0 }} />
          <div>
                        ...
                        background:
                          col.key === 'done'
                            ...
                            : col.key === 'inprogress'
                              ...
                              : '#FAFAFA',
                        border: `1px solid ${col.key === 'done' ? 'rgba(16,185,129,0.18)' : col.key === 'inprogress' ? 'rgba(79,142,247,0.18)' : '#F9FAFB'}`,
                        borderRadius: 8,
                        padding: '8px 10px',
                        cursor: 'pointer',
                        userSelect: 'none',
                      ...
                      {col.key !== 'done' && (
                        <button
                          ...
                          style={{
                            ...
                            fontSize: 10,
                            fontWeight: 600,
                            color: col.key === 'inprogress' ? '#4f8ef7' : '#9CA3AF',
                            background: 'none',
                            border: 'none',
                            cursor: 'pointer',
                            padding: 0,
