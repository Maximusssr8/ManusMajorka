...
function getVerdict(score: number): { label: string; color: string; dot: string } {
  ...
  if (score >= 50) return { label: 'Test First', color: '#3B82F6', dot: '🟡' };
    ...
    return (
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
          ...
          <span style={{ fontSize: 11, color: '#3B82F6', fontWeight: 700, fontFamily: "'Bricolage Grotesque', sans-serif", textTransform: 'uppercase', letterSpacing: '0.06em' }}>
            Scoring Opportunity...
          </span>
        </div>
        {[0, 1, 2, 3, 4].map(i => (
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
        <div>
          <div style={{ fontSize: 10, fontWeight: 700, color: '#3B82F6', fontFamily: "'Bricolage Grotesque', sans-serif", textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 3 }}>
        ...
        <div style={{ textAlign: 'center' }}>
          <div style={{
            ...
            fontSize: 36, color: '#3B82F6', lineHeight: 1,
