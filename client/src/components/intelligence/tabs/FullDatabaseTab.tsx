...
export function FullDatabaseTab() {
  ...
  return (
    <div className="flex flex-col" style={{ background: '#04060f' }}>
      ...
      {!showSkeleton && displayProducts.length === 0 && (
        <div className="flex flex-col items-center justify-center py-24 gap-4">
          ...
          <button
            ...
            className="bg-[#4f8ef7] hover:bg-[#4f8ef7] text-white px-5 py-2.5 rounded-lg text-[13px] font-medium transition-colors"
          >
          ...
          >
            ...
            {(selectedProduct.product_url || selectedProduct.source_url) && (
              <a
                ...
                className="mt-4 block bg-[#4f8ef7] hover:bg-[#4f8ef7] text-white text-[13px] font-medium py-2.5 px-4 rounded-lg text-center transition-colors"
              >
                View on AliExpress ↗
              </a>
            )}
