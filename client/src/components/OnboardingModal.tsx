                    ...
                    style={{
                      background:
                        selectedLevel === level.id
                          ...
                          : '#FAFAFA',
                      border: `1.5px solid ${selectedLevel === level.id ? 'rgba(59,130,246,0.4)' : '#E5E7EB'}`,
                      cursor: 'pointer',
                    }}
                  >
                    ...
                    <div>
                      <div
                        ...
                        style={{
                          ...
                          color: selectedLevel === level.id ? '#3B82F6' : '#0A0A0A',
                        }}
                      >
                        {level.label}
                      </div>
                    ...
                    style={{
                      background:
                        selectedBudget === budget.id
                          ...
                          : '#FAFAFA',
                      border: `1.5px solid ${selectedBudget === budget.id ? 'rgba(59,130,246,0.60)' : '#E5E7EB'}`,
                      cursor: 'pointer',
                    }}
                  >
                    ...
                    <div>
                      <div
                        ...
                        style={{
                          fontFamily: "'Bricolage Grotesque', sans-serif",
                          color: selectedBudget === budget.id ? '#3B82F6' : '#0A0A0A',
                        }}
                      >
                        {budget.label}
                      </div>
