...
export default function UsageCounter({ feature }: UsageCounterProps) {
  ...
  const barColor = atLimit || warning ? '#ef4444' : '#3B82F6';

  return (
    <div
      style={{
        background: atLimit ? 'rgba(239,68,68,0.04)' : 'rgba(59,130,246,0.04)',
        border: `1px solid ${atLimit ? 'rgba(239,68,68,0.3)' : 'rgba(59,130,246,0.15)'}`,
        borderRadius: 12,
        padding: '14px 18px',
        marginBottom: 20,
        display: 'flex',
