...
const BLINK_STYLE = `
  ...
  @keyframes sba-gold-pulse { 0%, 100% { box-shadow: 0 0 40px rgba(59,130,246,0.08), 0 0 80px rgba(100,149,237,0.06); } 50% { box-shadow: 0 0 60px rgba(59,130,246,0.18), 0 0 120px rgba(100,149,237,0.12); } }
    ...
    <>
          ...
          >
              ...
              {phase === 1 && (
                ...
                >
                  <div style={{
                    ...
                    fontSize: 13, color: '#3B82F6', letterSpacing: '0.02em',
              ...
              {(phase === 3 || phase === 4 || phase === 5) && browserStep >= 1 && (
                <motion.div
                  ...
                  style={{
                    ...
                    boxShadow: phase === 4
                      ? '0 0 40px rgba(59,130,246,0.12), inset 0 0 60px rgba(0,0,0,0.3)'
                ...
                >
                  ...
                  <div style={{
                    ...
                    borderBottom: '1px solid #F9FAFB', flexShrink: 0,
                  }}>
                  ...
                  <div style={{
                    ...
                    <AnimatePresence>
                      {browserStep >= 2 && (
                        ...
                        >
                          <span style={{
                            fontFamily: "'Bricolage Grotesque', sans-serif", color: '#3B82F6',
                          ...
                          >
                            ...
                            <div style={{
                                ...
                                <svg width="32" height="32" viewBox="0 0 24 24" fill="none">
                                  <rect x="2" y="3" width="20" height="14" rx="2" stroke="#3B82F6" strokeOpacity="0.35" strokeWidth="1.5"/>
                                  <path d="M8 21h8M12 17v4" stroke="#3B82F6" strokeOpacity="0.35" strokeWidth="1.5" strokeLinecap="round"/>
                                </svg>
                                <span style={{ color: 'rgba(59,130,246,0.4)', fontSize: 10, letterSpacing: '0.12em', fontFamily: "'Bricolage Grotesque', sans-serif" }}>PRODUCT</span>
                              </div>
                          </motion.div>
                        )}
                      </AnimatePresence>
                            ...
                            >
                              ...
                              {titleTypingActive && displayedTitle.length < productTitle.length && (
                                <span style={{
                                  ...
                                  background: '#3B82F6', marginLeft: 1,
                                  animation: 'sba-blink 0.8s step-end infinite', verticalAlign: 'middle',
                                }} />
                              )}
                            </motion.div>
                        ...
                        <AnimatePresence>
                          {browserStep >= 5 && (
                            <motion.div
                              ...
                              style={{ fontFamily: "'Bricolage Grotesque', sans-serif", fontSize: 18, fontWeight: 800, color: '#3B82F6' }}
                            >
                              $89.99 AUD
                            </motion.div>
                          )}
                          ...
                          {browserStep >= 6 && (
                            <motion.button
                              ...
                              style={{
                                ...
                                boxShadow: '0 0 20px rgba(59,130,246,0.4)', letterSpacing: '0.03em',
                              }}
                            >
                              Add to Cart
                            </motion.button>
                    ...
                    <div style={{ marginTop: 18 }}>
                      <div style={{
                        ...
                        <motion.div
                          ...
                          style={{
                            height: '100%',
                            background: 'linear-gradient(90deg, #3B82F6, #f0cc6a)',
                            borderRadius: 4,
                          }}
                        />
                      </div>
            ...
            <AnimatePresence>
              {phase === 6 && (
                ...
                >
                  <div style={{ color: '#3B82F6', fontSize: 14, fontWeight: 700, marginBottom: 20 }}>
                      ...
                      {ordersStep > i && (
                        ...
                        >
                          <div style={{
                            ...
                            <span style={{
                              fontFamily: 'monospace', color: '#3B82F6',
            ...
            <AnimatePresence>
              {phase === 8 && (
                <motion.div
                  ...
                  style={{ ...PANEL_STYLE, zIndex: 30 }}
                >
                  <div style={{ color: '#3B82F6', fontSize: 14, fontWeight: 700, marginBottom: 4 }}>
                    📦 AUTO FULFILMENT
                  </div>
                  ...
                  {([
                    ...
                    <AnimatePresence key={item.id}>
                      {fulfilmentStep > i && (
                        ...
                        >
                          <span style={{ fontFamily: 'monospace', color: '#3B82F6', width: 46 }}>{item.id}</span>
                          <div style={{
                            ...
                            <motion.div
                              ...
                              style={{
                                height: '100%',
                                background: item.shipped ? '#4ade80' : '#3B82F6',
                                borderRadius: 3,
                              }}
                            />
                          </div>
            ...
            <AnimatePresence>
              {phase === 9 && (
                <motion.div
                  ...
                  style={{ ...PANEL_STYLE, zIndex: 30 }}
                >
                  <div style={{ color: '#3B82F6', fontSize: 14, fontWeight: 700, marginBottom: 16 }}>
                    💰 TODAY'S PERFORMANCE
                  </div>
                  ...
                  <div style={{ marginBottom: 18 }}>
                    ...
                    <div style={{
                      ...
                      color: '#3B82F6',
                      textShadow: '0 0 30px rgba(59,130,246,0.55), 0 0 60px rgba(59,130,246,0.25)',
                    }}>
                  ...
                  <div>
                    <div style={{
                      ...
                      <motion.div
                        ...
                        style={{ height: '100%', background: '#3B82F6', borderRadius: 4 }}
                      />
                    </div>
      ...
      {!visible && (
        <div style={{
          ...
          background: '#05070F', border: '1px solid rgba(59,130,246,0.05)',
        }} />
      )}
