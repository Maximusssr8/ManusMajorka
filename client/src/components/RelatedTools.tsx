...
export default function RelatedTools({ currentToolId }: RelatedToolsProps) {
  ...
  return (
    <div className="border-t px-5 py-4 flex-shrink-0" style={{ borderColor: "rgba(255,255,255,0.06)" }}>
      <div className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: "rgba(240,237,232,0.3)", fontFamily: "Syne, sans-serif" }}>
        Related Tools
      </div>
          ...
          return (
            ...
            >
              <div className="flex items-center gap-2 mb-1">
                ...
                <div className="text-xs font-bold" style={{ fontFamily: "Syne, sans-serif", color: "#f0ede8" }}>
                  {tool.label}
                </div>
              </div>
              <div className="text-xs leading-snug" style={{ color: "rgba(240,237,232,0.35)", fontSize: 10 }}>
                {tool.description}
              </div>
            </button>
          );
