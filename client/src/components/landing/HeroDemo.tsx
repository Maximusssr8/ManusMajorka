...
export function HeroDemo() {
  ...
  return (
    <div className="relative w-full max-w-[720px]" style={{ margin: '0 auto' }}>
      ...
      <div className="absolute inset-0 -z-10 rounded-full scale-75 blur-3xl opacity-20 pointer-events-none" style={{ background: '#d4af37' }} />
    </div>
  );
}
...
function initDemoEngine(mount: HTMLElement, data: DemoData, avgScore: number): () => void {
  ...
  const alertIcons = ['🔥','💰','📈'];
  const alertIconBgs = ['rgba(251,146,60,0.12)','rgba(212,175,55,0.12)','rgba(52,211,153,0.12)'];
  const alertBadges = [{ label:'HOT',cls:'orange' },{ label:'RISING',cls:'gold' },{ label:'TREND',cls:'green' }];
      ...
      <div class="mkr-panel mkr-panel-market" id="mkr-panel-market" style="z-index:0;pointer-events:none">
        ...
        <div class="mkr-gauge-wrap">
          <svg width="100" height="60" viewBox="0 0 100 60">
            ...
            <circle cx="50" cy="30" r="20" fill="none" stroke="#d4af37" stroke-width="5"
          ...
          <div class="mkr-gauge-label">
            <div style="color:#d4af37;font-size:18px;font-weight:700">${d.avgScore}</div>
        ...
        <div class="mkr-chart-wrap">
          ...
          <svg width="300" height="60" viewBox="0 0 300 60" class="mkr-chart-svg">
            ...
            <polyline points="${d.chartPoints}" fill="none" stroke="#d4af37" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="mkr-chart-line"/>
          </svg>
        </div>
      </div>
