            ...
            {STATS.map((stat) => (
              ...
              >
                <div
                  ...
                  style={{ fontFamily: "'Syne', sans-serif", color: '#e5c158' }}
                >
                  {stat.value}
                </div>
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      border: `1px solid ${selected ? 'rgba(212,175,55,0.4)' : 'rgba(255,255,255,0.08)'}`,
                      cursor: 'pointer',
                    }}
                  >
                    <div
                      ...
                      style={{
                        background: selected ? 'rgba(212,175,55,0.2)' : 'rgba(255,255,255,0.06)',
                      }}
                    >
                      <Icon size={14} style={{ color: selected ? '#e5c158' : '#71717a' }} />
                    </div>
                    <span
                      className="text-sm"
                    ...
                    <div className="ml-auto flex-shrink-0">
                      <div
                        ...
                        style={{
                          border: `2px solid ${selected ? '#d4af37' : '#D1D5DB'}`,
