            ...
            {STATS.map((stat) => (
              ...
              >
                <div
                  ...
                  style={{ fontFamily: "'Syne', sans-serif", color: '#6ba3ff' }}
                >
                  {stat.value}
                </div>
              ...
              {GOALS.map((goal) => {
                ...
                return (
                  <button
                    ...
                    style={{
                      background: selected ? 'rgba(79,142,247,0.12)' : 'rgba(255,255,255,0.04)',
                      border: `1px solid ${selected ? 'rgba(79,142,247,0.4)' : 'rgba(255,255,255,0.08)'}`,
                      cursor: 'pointer',
                    }}
                  >
                    <div
                      ...
                      style={{
                        background: selected ? 'rgba(79,142,247,0.2)' : 'rgba(255,255,255,0.06)',
                      }}
                    >
                      <Icon size={14} style={{ color: selected ? '#6ba3ff' : '#71717a' }} />
                    </div>
                    <span
                      className="text-sm"
                    ...
                    <div className="ml-auto flex-shrink-0">
                      <div
                        ...
                        style={{
                          border: `2px solid ${selected ? '#4f8ef7' : '#D1D5DB'}`,
