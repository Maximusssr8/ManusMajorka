...
import { X, Search, Palette, Globe, Megaphone, Compass } from "lucide-react";
...
const GOALS = [
  { id: "find-product", label: "Find a winning product to sell", icon: Search, path: "/app/product-discovery" },
  { id: "build-brand", label: "Build my brand identity", icon: Palette, path: "/app/brand-dna" },
  { id: "create-store", label: "Create my Shopify store", icon: Globe, path: "/app/website-generator" },
    ...
    >
      ...
      >
        ...
        <button
          ...
          style={{ background: "rgba(255,255,255,0.05)", border: "none", color: "#52525b", cursor: "pointer" }}
        >
          <X size={14} />
        </button>
        ...
        <div className="px-8 py-10">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-sm" style={{ color: "rgba(245,245,245,0.5)", lineHeight: 1.6 }}>
              G'day {firstName}! You've just unlocked Australia's most powerful ecommerce AI toolkit.
            </p>
          </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="ml-auto flex-shrink-0">
                      ...
                      >
                        {selected && (
                          <div className="w-1.5 h-1.5 rounded-full" style={{ background: "#080a0e" }} />
                        )}
                      </div>
                    </div>
                  </button>
