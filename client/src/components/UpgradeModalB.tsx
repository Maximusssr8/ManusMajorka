      ...
      >
        ...
        <div className="p-6 text-center">
          <div className="text-4xl mb-3">
            <Coffee size={40} style={{ color: '#3B82F6', margin: '0 auto' }} />
          </div>
          <h2
          ...
          <p className="text-sm mb-1" style={{ color: '#94A3B8' }}>
            For <span style={{ color: '#3B82F6', fontWeight: 700 }}>$1.63/day</span>, get an entire
          ...
          >
            ...
            <div className="h-px my-2" style={{ background: 'rgba(59,130,246,0.2)' }} />
          ...
          <div className="flex items-center justify-center gap-1 mt-4 mb-5">
            {[1, 2, 3, 4, 5].map((i) => (
              <Star key={i} size={12} fill="#3B82F6" style={{ color: '#3B82F6' }} />
            ))}
