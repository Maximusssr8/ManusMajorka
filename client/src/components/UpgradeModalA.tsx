        ...
        <div className="p-6 pt-4 grid grid-cols-2 gap-3">
          {PLANS.map((plan) => (
            <div
              ...
              style={{
                background: plan.popular ? 'rgba(59,130,246,0.06)' : '#FAFAFA',
                border: `1.5px solid ${plan.popular ? 'rgba(59,130,246,0.3)' : '#F9FAFB'}`,
              }}
            >
              {plan.popular && (
                <div
              ...
              <div className="mb-3">
                ...
                <div className="flex items-baseline gap-0.5">
                  <span
                    ...
                    style={{
                      fontFamily: "'Bricolage Grotesque', sans-serif",
                      color: plan.popular ? '#3B82F6' : '#0A0A0A',
                    }}
                  >
                    {plan.price}
                  </span>
                ...
                {plan.features.map((f) => (
                  <div key={f} className="flex items-start gap-2">
                    <Check
                      ...
                      style={{ color: plan.popular ? '#3B82F6' : '#4ade80' }}
                    />
