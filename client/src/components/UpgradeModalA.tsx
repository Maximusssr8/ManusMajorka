    ...
    >
      ...
      >
        ...
        <div className="p-6 pb-2 text-center">
          ...
          >
            <Zap size={12} style={{ color: '#4f8ef7' }} />
            <span
        ...
        <div className="p-6 pt-4 grid grid-cols-2 gap-3">
          {PLANS.map((plan) => (
            <div
              ...
              style={{
                background: plan.popular ? 'rgba(79,142,247,0.06)' : '#FAFAFA',
                border: `1.5px solid ${plan.popular ? 'rgba(79,142,247,0.3)' : '#F9FAFB'}`,
              }}
            >
              {plan.popular && (
                <div
              ...
              <div className="mb-3">
                ...
                <div className="flex items-baseline gap-0.5">
                  <span
                    ...
                    style={{
                      fontFamily: "'Syne', sans-serif",
                      color: plan.popular ? '#4f8ef7' : '#0A0A0A',
                    }}
                  >
                    {plan.price}
                  </span>
                ...
                {plan.features.map((f) => (
                  <div key={f} className="flex items-start gap-2">
                    <Check
                      ...
                      style={{ color: plan.popular ? '#4f8ef7' : '#4ade80' }}
                    />
