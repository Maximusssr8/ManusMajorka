...
export default function RadialOrbitalTimeline({ timelineData }: RadialOrbitalTimelineProps) {
  ...
  const getStatusStyles = (status: TimelineItem['status']): string => {
    switch (status) {
      ...
      case 'in-progress':
        return 'text-black bg-[#0d0d10] border-black';
      case 'pending':
            ...
            return (
              ...
              >
                  ...
                  style={{
                    ...
                    borderColor: isExpanded
                      ...
                      : isRelated
                        ? '#3B82F6'
                        : 'rgba(59,130,246,0.4)',
                    color: isExpanded ? '#FAFAFA' : '#3B82F6',
                    boxShadow: isExpanded ? '0 0 20px rgba(59,130,246,0.5)' : 'none',
                  }}
                >
                  <Icon size={16} />
                </div>
                ...
                <div
                  ...
                  style={{
                    color: isExpanded ? '#3B82F6' : '#374151',
