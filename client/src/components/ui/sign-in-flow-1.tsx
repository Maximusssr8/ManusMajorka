...
export const SignInPage = ({ className, onSuccess, onGoogleSignIn, onAppleSignIn, onEmailSignIn }: SignInPageProps) => {
      ...
      <div className="absolute inset-0 z-0">
        {initialCanvasVisible && (
          <div className="absolute inset-0">
            <CanvasRevealEffect animationSpeed={3} containerClassName="bg-black" colors={[[212, 175, 55], [212, 175, 55]]} dotSize={6} reverse={false} />
          </div>
        )}
        {reverseCanvasVisible && (
          <div className="absolute inset-0">
            <CanvasRevealEffect animationSpeed={4} containerClassName="bg-black" colors={[[212, 175, 55], [212, 175, 55]]} dotSize={6} reverse={true} />
          </div>
        )}
          ...
          <div className="w-full mt-24 max-w-sm">
            <AnimatePresence mode="wait">
              {step === "email" && (
                ...
                >
                  <div>
                    <div className="w-12 h-12 bg-[#d4af37] rounded-xl flex items-center justify-center font-black text-black text-xl mx-auto mb-4" style={{ fontFamily: "Syne, sans-serif" }}>
                      M
                    </div>
                    <h1 className="text-4xl font-bold text-white tracking-tight" style={{ fontFamily: "Syne, sans-serif" }}>Welcome back</h1>
                    ...
                    <form onSubmit={handleEmailSubmit}>
                      <div className="relative">
                        ...
                        <button
                          ...
                          className="absolute right-1.5 top-1.5 w-9 h-9 flex items-center justify-center rounded-full bg-[#d4af37] hover:bg-[#c9a227] text-black transition-colors font-bold disabled:opacity-50"
                        >
                          {isSubmitting ? "..." : "\u2192"}
                        </button>
                      </div>
              ...
              {step === "code" && (
                ...
                >
                  ...
                  {error && <p className="text-red-400 text-sm">{error}</p>}
                  <p className="text-white/40 text-sm cursor-pointer hover:text-white/60 transition-colors">Resend code</p>
