    ...
    >
      ...
      {showConfetti && (
        <div className="absolute inset-0 pointer-events-none z-10 flex items-center justify-center gap-4">
          <span className="text-3xl animate-bounce" style={{ animationDelay: "0ms" }}>{"\u{1F389}"}</span>
          <span className="text-sm font-bold" style={{ fontFamily: "Syne, sans-serif", color: "#d4af37" }}>
            You're a power user!
          </span>
          <span className="text-3xl animate-bounce" style={{ animationDelay: "150ms" }}>{"\u{1F389}"}</span>
        </div>
      )}
