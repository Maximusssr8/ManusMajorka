  ...
  return (
    <motion.div
      ...
      style={{
        ...
        background:
          'linear-gradient(135deg, rgba(79,142,247,0.08) 0%, rgba(17,17,17,1) 50%, rgba(79,142,247,0.04) 100%)',
        boxShadow: '0 20px 60px -20px rgba(79,142,247,0.3)',
      }}
    >
      <div className="pointer-events-none absolute -right-8 -top-8 h-32 w-32 rounded-full bg-[#4f8ef7]/10 blur-3xl" />
      <div className="relative">
        <div className="mb-4 flex items-center justify-between">
          <span className="text-[9px] font-mono uppercase tracking-widest text-[#9CA3AF]">Majorka Academy</span>
          <Award size={20} className="text-[#4f8ef7]" strokeWidth={1.5} />
        </div>
        <div className="mb-1 text-[10px] font-mono uppercase tracking-widest text-[#4f8ef7]">Certified</div>
        <div
        ...
        <div className="border-t border-[#4f8ef7]/15 pt-4">
