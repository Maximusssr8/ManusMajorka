      ...
      return (
        ...
        >
          <div className="flex flex-col items-center w-full max-w-xl">
            ...
            <p className="text-sm mb-6 text-center" style={{ color: "rgba(240,237,232,0.45)", maxWidth: 380 }}>
              An unexpected error occurred. You can try reloading the page or heading back to the dashboard.
            </p>
              ...
              >
                ...
                <div className="px-4 pb-4">
                  <pre
                    ...
                    style={{ background: "rgba(0,0,0,0.3)", color: "rgba(240,237,232,0.5)", maxHeight: 200 }}
                  >
