...
const tplB: WebsiteTemplate = {
  ...
  category: 'bold',
  palette: { bg: '#0d0d1a', accent: '#4f8ef7', text: '#f0ecff' },
  emoji: '🔥',
...
const tplE: WebsiteTemplate = {
  ...
  category: 'tech',
  palette: { bg: '#04060f', accent: '#3b82f6', text: '#f5f5f7' },
  emoji: '🖥️',
...
<style>
*{margin:0;padding:0;box-sizing:border-box}
:root{--accent:{BRAND_COLOR};--bg:#04060f;--surface:#101010;--card:#161616;--text:#f5f5f7;--muted:#86868b;--border:rgba(255,255,255,.07)}
...
export function buildTemplatePreview(
  ...
  return tmpl.html
    ...
    .replace(/{BRAND_COLOR}/g, brandColor || '#4f8ef7')
