export function getCategoryColor(category: string): string {
  ...
  return 'bg-[#4f8ef7]/20 text-[#6ba3ff] border border-[#4f8ef7]/30';
}
...
export function getCategoryStyle(category: string): { background: string; color: string; border: string } {
  ...
  if (cat.includes('kids') || cat.includes('baby') || cat.includes('child')) return { background: 'rgba(79,142,247,0.15)', color: '#a78bfa', border: '1px solid rgba(79,142,247,0.3)' };
  ...
  if (cat.includes('supplement')) return { background: 'rgba(79,142,247,0.15)', color: '#6ba3ff', border: '1px solid rgba(79,142,247,0.3)' };
  ...
  return { background: 'rgba(79,142,247,0.15)', color: '#6ba3ff', border: '1px solid rgba(79,142,247,0.3)' };
}
