...
function PlatformPill({ platform }: { platform: string }) {
  const color = PLATFORM_COLOURS[platform] ?? '#4f8ef7';
  return (
    <span
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            >
              <Package className="w-4 h-4" style={{ color: '#4f8ef7' }} />
            </div>
            <div>
              <h1
          ...
          {topSupplier && !loading && (
            ...
            >
              <div className="flex items-center gap-2 mb-3">
                <TrendingUp className="w-4 h-4" style={{ color: '#4f8ef7' }} />
                <span
              ...
              >
                ...
                <strong style={{ color: '#4f8ef7' }}>{fmt(snapSellPrice)}</strong>:
              </p>
          ...
          {suppliers.length > 0 && !loading && (
            ...
            >
              ...
              {suppliers.map((s, i) => {
                ...
                const profitColor =
                  s.profit_margin_pct >= 60 ? '#10b981' : s.profit_margin_pct >= 40 ? '#4f8ef7' : '#f87171';
                return (
                  <div
                    key={i}
                  ...
                  >
                    ...
                    <span
                      style={{
                        color: s.shipping_days_to_au <= 10 ? '#10b981' : s.shipping_days_to_au <= 15 ? '#4f8ef7' : '#6B7280',
                      }}
                    >
