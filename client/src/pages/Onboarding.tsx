...
const GOLD = '#3B82F6';
const GOLD_DIM = 'rgba(59,130,246,0.18)';
const GOLD_BORDER = 'rgba(59,130,246,0.4)';
const DIM_BG = '#FAFAFA';
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: 'none',
                      boxShadow: storeType ? '0 8px 24px rgba(59,130,246,0.2)' : 'none',
                    }}
                  >
              ...
              >
                ...
                >
                  ...
                  {taskLoading ? (
                    ...
                    <>
                      <p className="text-sm leading-relaxed mb-4" style={{ color: '#F8FAFC' }}>
                        {firstTask}
                      </p>
                      <button
