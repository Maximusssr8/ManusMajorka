          ...
          <div className="flex items-center gap-2">
            ...
            {isScale && (
              <button onClick={triggerProductRefresh} disabled={refreshingProducts}
                style={{ height: 30, padding: '0 10px', background: refreshingProducts ? '#9CA3AF' : 'white', color: refreshingProducts ? 'white' : '#3B82F6', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 8, fontSize: 11, fontWeight: 600, cursor: refreshingProducts ? 'wait' : 'pointer', display: 'flex', alignItems: 'center', gap: 4 }}>
                {refreshingProducts ? (
      ...
      <div className="p-6 space-y-8">
        ...
        <section>
          <div className="flex items-center justify-between mb-3">
            ...
            <button onClick={() => nav('/app/winning-products')} className="text-xs" style={{ color: '#3B82F6' }}>View all →</button>
          </div>
          <div
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <button onClick={() => nav('/app/creators')} className="text-xs" style={{ color: '#3B82F6' }}>All →</button>
            </div>
            {loading ? (
              ...
              >
                <div className="flex items-start gap-3 mb-4">
                  <div
                    ...
                    style={{ backgroundImage: topCreator.avatar_url ? `url(${topCreator.avatar_url})` : undefined, background: topCreator.avatar_url ? undefined : 'rgba(59,130,246,0.2)' }}
                  />
                ...
                <div className="flex items-center justify-between mb-3">
                  <div>
                    ...
                    <p className="text-xl font-bold" style={{ color: '#3B82F6', fontFamily: "'Bricolage Grotesque', sans-serif" }}>
