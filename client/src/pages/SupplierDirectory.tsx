...
export default function SupplierDirectory() {
  ...
  const btnStyle = (active: boolean) => ({
    ...
    background: active ? 'rgba(79,142,247,0.12)' : C.surface,
        ...
        {filtered.map(s => (
          ...
          >
            ...
            <div style={{ display: 'flex', gap: 6, marginBottom: 10, flexWrap: 'wrap' }}>
              {s.beginner_friendly && (
                <span style={{ fontSize: 9, fontWeight: 800, padding: '3px 7px', borderRadius: 4, background: 'rgba(79,142,247,0.15)', color: C.gold, fontFamily: "'Syne', sans-serif", textTransform: 'uppercase', letterSpacing: '0.06em' }}>
                  Beginner Friendly
                </span>
              )}
              {s.au_warehouse && (
