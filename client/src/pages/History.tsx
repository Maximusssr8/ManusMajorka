...
import { Search, Trash2, ArrowLeft, Clock, ArrowUpRight, Filter } from "lucide-react";
      ...
      <div className="max-w-3xl mx-auto px-6 py-8">
        ...
        {entries.length > 0 && (
          <div className="flex gap-2 mb-6">
            <div className="relative flex-1">
              <Search size={12} className="absolute left-3 top-1/2 -translate-y-1/2" style={{ color: "#52525b" }} />
              <input
                value={searchQuery}
            ...
            <div className="relative">
              ...
              <Filter size={10} className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none" style={{ color: "#52525b" }} />
            </div>
          </div>
        )}
        ...
        {entries.length === 0 ? (
          <div className="text-center py-16">
            ...
            <h2 className="text-base font-bold mb-2" style={{ fontFamily: "Syne, sans-serif", color: "#f5f5f5" }}>
              No history yet
            </h2>
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="text-xs" style={{ color: "#52525b" }}>
                            {entry.type === "tool_opened" ? "Opened tool" : entry.type === "product_imported" ? "Imported product" : entry.type === "output_saved" ? "Saved output" : entry.type}
                          </div>
                        </div>
                        ...
                        {tool && (
                          <button
                            ...
                            style={{ color: "#d4af37", background: "rgba(212,175,55,0.08)", border: "none", cursor: "pointer" }}
                          >
                            Open
                          </button>
                        )}
