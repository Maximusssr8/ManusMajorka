      ...
      <div className="max-w-3xl mx-auto px-6 py-8">
          ...
          <div className="flex gap-2 mb-6">
            <div className="relative flex-1">
              ...
              <input
                ...
                onFocus={(e) => (e.target.style.borderColor = 'rgba(79,142,247,0.3)')}
        ...
        {entries.length === 0 ? (
          <div className="text-center py-16">
            ...
            >
              <Clock size={24} style={{ color: '#4f8ef7', opacity: 0.4 }} />
            </div>
            <h2
                  ...
                  {group.entries.map(({ entry, idx }) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          {tool ? (
                            createElement(tool.icon, { size: 13, style: { color: '#4f8ef7' } })
                          ) : (
