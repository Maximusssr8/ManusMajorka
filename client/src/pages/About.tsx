    ...
    <div style={{ minHeight: '100vh', background: '#05070F', fontFamily: dm }}>
      ...
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '72px 24px 56px', textAlign: 'center' }}>
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: 6, background: 'rgba(79,142,247,0.08)', borderRadius: 20, padding: '4px 14px', marginBottom: 20 }}>
          <span style={{ fontSize: 12, fontWeight: 700, color: '#4f8ef7', letterSpacing: '0.06em', textTransform: 'uppercase' as const }}>About Majorka</span>
        </div>
      ...
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '0 24px 80px' }}>
        <div style={{ background: 'linear-gradient(135deg, #4f8ef7, #4f8ef7)', borderRadius: 20, padding: '48px', textAlign: 'center' }}>
          ...
          <Link href="/sign-up" style={{ display: 'inline-block', background: '#0d0d10', color: '#4f8ef7', borderRadius: 10, padding: '14px 36px', fontWeight: 700, fontSize: 16, textDecoration: 'none', letterSpacing: '-0.01em' }}>
            Get Started Free →
          </Link>
        </div>
      </div>
