  ...
  return (
    <div style={{ minHeight: '100vh', background: C.bg, fontFamily: dm }}>
      ...
      <style>{`
        ...
        input[type="range"]::-webkit-slider-thumb { -webkit-appearance: none; appearance: none; width: 18px; height: 18px; border-radius: 50%; background: #3B82F6; cursor: pointer; border: 2px solid #060608; }
      `}</style>
    </div>
  );
}
