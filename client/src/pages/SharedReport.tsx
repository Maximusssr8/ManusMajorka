...
export default function SharedReport() {
  ...
  if (error) return (
    <div style={{ display: 'flex', flexDirection: 'column' as const, justifyContent: 'center', alignItems: 'center', minHeight: '100vh', gap: 12 }}>
      ...
      <a href="/" style={{ fontSize: 13, color: '#4f8ef7', fontWeight: 600 }}>Try Majorka free \u2192</a>
    </div>
  );
  ...
  return (
    <div style={{ background: '#05070F', minHeight: '100vh' }}>
      ...
      <div style={{ background: '#0d0d10', borderBottom: '1px solid rgba(255,255,255,0.06)', padding: '14px 32px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div style={{ fontFamily: brico, fontWeight: 800, fontSize: 20, color: '#4f8ef7' }}>Majorka</div>
        <a href="/signup" style={{ height: 34, padding: '0 16px', background: '#4f8ef7', color: 'white', borderRadius: 8, fontSize: 12, fontWeight: 600, textDecoration: 'none', display: 'flex', alignItems: 'center' }}>
          Get free access \u2192
        </a>
      </div>
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '32px 24px' }}>
            ...
            <div style={{ display: 'flex', gap: 14 }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' as const }}>
                  {p.winning_score && <div style={{ fontSize: 12, color: '#4f8ef7', fontWeight: 600 }}>Score: {p.winning_score}/100</div>}
                  ...
                  {p.aliexpress_url && <a href={p.aliexpress_url} target="_blank" rel="noopener noreferrer" style={{ fontSize: 12, color: '#4f8ef7', fontWeight: 600 }}>View Supplier \u2192</a>}
                </div>
              </div>
            </div>
          </div>
        ...
        {/* CTA */}
        <div style={{ background: 'rgba(79,142,247,0.08)', border: '1px solid #C7D2FE', borderRadius: 16, padding: '32px 24px', textAlign: 'center' as const, marginTop: 32 }}>
          ...
          <a href="/signup" style={{ display: 'inline-block', height: 44, lineHeight: '44px', padding: '0 24px', background: '#4f8ef7', color: 'white', borderRadius: 10, fontSize: 14, fontWeight: 700, textDecoration: 'none' }}>
            Start free \u2192
          </a>
        </div>
