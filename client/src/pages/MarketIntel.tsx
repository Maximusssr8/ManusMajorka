      ...
      <div className="flex-shrink-0 border-b p-4" style={{ borderColor: "rgba(255,255,255,0.08)" }}>
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">Analyze market trends and competitive landscape</p>
          </div>
        </div>
      </div>
            ...
            {messages.length === 0 && (
              <div className="flex flex-col items-center justify-center h-full text-center py-12">
                ...
                <p className="text-sm text-muted-foreground max-w-xs">
                  Tell me about your market or product, and I'll provide competitive intelligence and market insights.
                </p>
              </div>
            )}
              ...
              <div className="flex gap-3 justify-start">
                ...
                <div className="bg-muted rounded-lg px-4 py-2.5">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-muted-foreground">Researching market intelligence...</span>
                  </div>
                </div>
              </div>
            )}
