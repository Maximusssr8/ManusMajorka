      ...
      <div className="flex-shrink-0 border-b p-4" style={{ borderColor: '#F5F5F5' }}>
        <div className="flex items-center gap-3">
          <div
            ...
            style={{ background: 'linear-gradient(135deg, #3B82F6, #8B5CF6)', color: '#FAFAFA' }}
          >
            I
          </div>
          <div>
          ...
          <div className="space-y-4 p-4">
            {messages.length === 0 && (
              <div className="flex flex-col items-center justify-center h-full text-center py-12">
                <Sparkles className="w-12 h-12 mb-4" style={{ color: '#3B82F6', opacity: 0.3 }} />
          ...
          <div className="flex gap-2">
            ...
            <div className="flex flex-col gap-2">
              <Button
                ...
                size="sm"
                style={{
                  background: 'linear-gradient(135deg, #3B82F6, #c09a28)',
                  color: '#FAFAFA',
                }}
              >
