      ...
      <div className="flex-shrink-0 border-b p-4" style={{ borderColor: '#F5F5F5' }}>
        <div className="flex items-center gap-3">
          <div
            ...
            style={{ background: 'linear-gradient(135deg, #4f8ef7, #4f8ef7)', color: '#FAFAFA' }}
          >
            I
          </div>
          <div>
          ...
          <div className="space-y-4 p-4">
            {messages.length === 0 && (
              <div className="flex flex-col items-center justify-center h-full text-center py-12">
                <Sparkles className="w-12 h-12 mb-4" style={{ color: '#4f8ef7', opacity: 0.3 }} />
              ...
              >
                {msg.role === 'assistant' && (
                  <div className="w-8 h-8 shrink-0 rounded-full bg-primary/10 flex items-center justify-center">
                    <Sparkles className="w-4 h-4" style={{ color: '#4f8ef7' }} />
                  </div>
                )}
          ...
          <div className="flex gap-2">
            ...
            <div className="flex flex-col gap-2">
              <Button
                ...
                size="sm"
                style={{
                  background: 'linear-gradient(135deg, #4f8ef7, #c09a28)',
                  color: '#FAFAFA',
                }}
              >
