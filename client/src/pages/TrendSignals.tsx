      ...
      {products.length > 0 && (
        <div style={{ marginBottom: 28 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
            ...
            <span style={{ fontSize: 13, fontWeight: 700, color: '#4f8ef7', fontFamily: "'Syne', sans-serif", textTransform: 'uppercase' as const, letterSpacing: '1px' }}>
              Top 10 Today
            </span>
              ...
              .map((p, idx) => (
                <div key={p.id || p.name + '-top'}
                  style={{
                    ...
                    border: `1px solid ${idx === 0 ? '#4f8ef7' : '#E5E7EB'}`,
                    borderRadius: 10, overflow: 'hidden', cursor: 'pointer', transition: 'border-color 0.15s',
                  }}
                  onMouseEnter={e => (e.currentTarget as HTMLDivElement).style.borderColor = '#4f8ef7'}
                  onMouseLeave={e => (e.currentTarget as HTMLDivElement).style.borderColor = idx === 0 ? '#4f8ef7' : '#E5E7EB'}
                >
                  <div style={{ height: 90, overflow: 'hidden' }}>
                    <ProductImage src={p.image_url} alt={p.name || ''} size={90} style={{ width: '100%', height: 90, borderRadius: 0 }} />
                  </div>
                  <div style={{ padding: '8px 10px' }}>
                    <div style={{ fontSize: 11, fontWeight: 700, color: '#F8FAFC', lineHeight: 1.3, marginBottom: 4, overflow: 'hidden', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical' as const }}>
                      {p.name}
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                      <span style={{ fontSize: 12, fontWeight: 800, color: '#4f8ef7' }}>${p.estimated_retail_aud}</span>
                      <span style={{ fontSize: 10, fontWeight: 700, color: '#4f8ef7' }}>
      ...
      <div className="trend-filter-bar" style={{
        ...
        <label style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 11, color: C.muted, flex: '0 0 auto' }}>
          ...
          <input
            ...
            style={{
              width: 52, padding: '5px 7px', background: 'rgba(255,255,255,0.03)',
                ...
                return (
                  ...
                  >
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                        ...
                        <div style={{ minWidth: 0 }}>
                          <div style={{ display: 'flex', alignItems: 'center', gap: 5, flexWrap: 'wrap', marginBottom: 3 }}>
                            <span
                              ...
                              style={{
                                ...
                                cursor: 'help', textDecoration: p.trend_reason ? 'underline dotted rgba(79,142,247,0.3)' : 'none',
                              }}
                            >
                              {p.name}
                            </span>
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                            <span style={{ fontSize: 10, color: C.muted, background: 'rgba(255,255,255,0.03)', border: `1px solid ${C.border}`, borderRadius: 4, padding: '1px 6px' }}>
                              {p.niche}
                            </span>
                          </div>
                        </div>
                    ...
                    <td style={{ padding: '12px', whiteSpace: 'nowrap' }}>
                      <div style={{ fontSize: 15, fontWeight: 800, color: '#4f8ef7', fontFamily: "'Syne', sans-serif" }}>
                    ...
                    {/* Growth */}
                    <td style={{ padding: '12px', whiteSpace: 'nowrap' }}>
                      <span style={{ fontSize: 13, fontWeight: 700, color: (p.growth_rate_pct || 0) >= 0 ? '#4f8ef7' : '#ef4444' }}>
                          ...
                          {[1,2,3,4,5].map(i => (
                            <div key={i} style={{
                              ...
                              background: i <= Math.round((p.saturation_score || 5) / 2)
                                ? (p.saturation_score || 5) >= 7 ? '#4f8ef7' : (p.saturation_score || 5) >= 4 ? '#4f8ef7' : '#ef4444'
                                : '#E5E7EB',
                            }} />
                          ))}
                        </div>
                    ...
                    <td style={{ padding: '8px 12px' }}>
                      <div style={{ display: 'flex', gap: 6 }}>
                        <button
                          ...
                          style={{
                            height: 28, padding: '0 12px', background: '#4f8ef7', color: 'white',
                        ...
                        <button
                          ...
                          style={{
                            height: 28, padding: '0 12px', background: '#0d0d10', color: '#4f8ef7',
                            border: '1px solid #4f8ef7', borderRadius: 6, fontSize: 12, fontWeight: 600,
                            cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 4, whiteSpace: 'nowrap' as const,
                          }}
                        >
            ...
            <div key={p.id || p.name} style={{
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                ...
                <button onClick={() => {
                  ...
                  style={{ flex: 1, padding: '9px', background: 'rgba(255,255,255,0.03)', color: C.sub, border: `1px solid ${C.border}`, borderRadius: 7, fontSize: 12, cursor: 'pointer' }}>
                  Supplier →
                </button>
              </div>
            </div>
          ...
          {[...Array(totalPages)].map((_, i) => (
            <button
              ...
              style={{
                ...
                background: page === i + 1 ? 'rgba(79,142,247,0.12)' : C.surface,
