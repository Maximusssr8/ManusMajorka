    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-center gap-2 mb-4">
          ...
          <span className="text-slate-100 font-bold text-xl" style={{ fontFamily: "'Syne', sans-serif" }}>
            Majorka
          </span>
        </div>
        ...
        <div className="py-4">
          <div
            ...
            style={{ background: 'rgba(79,142,247,0.1)', border: '2px solid rgba(79,142,247,0.2)' }}
          >
            <svg
        ...
        <div>
          ...
          {email ? (
            <p className="text-sm" style={{ color: '#94A3B8' }}>
              ...
              <span className="font-medium" style={{ color: '#4f8ef7' }}>
                {email}
              </span>
            </p>
          ) : (
        ...
        >
          <div
            ...
            style={{ color: '#94A3B8' }}
          >
            <span style={{ color: '#4f8ef7' }}>1.</span> Open the email from Majorka
          </div>
          <div
            className="flex items-center gap-2 text-xs"
            style={{ color: '#94A3B8' }}
          >
            <span style={{ color: '#4f8ef7' }}>2.</span> Click the verification link
          </div>
          <div
            className="flex items-center gap-2 text-xs"
            style={{ color: '#94A3B8' }}
          >
            <span style={{ color: '#4f8ef7' }}>3.</span> You'll be taken to your dashboard
          </div>
        </div>
        ...
        <div>
          {email && !resent ? (
            <button
              ...
              style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#4f8ef7' }}
            >
