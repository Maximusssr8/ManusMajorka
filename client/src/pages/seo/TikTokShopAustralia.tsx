      ...
      <main style={{ maxWidth: 1100, margin: '0 auto', padding: '0 24px' }}>
        ...
        <section style={{ padding: '80px 0 60px', textAlign: 'center' }}>
          ...
          <h1 style={{ fontFamily: syne, fontWeight: 900, fontSize: 'clamp(2rem, 5vw, 3.5rem)', lineHeight: 1.1, letterSpacing: '-0.03em', marginBottom: 20 }}>
            ...
            <span style={{ background: `linear-gradient(135deg, ${C.gold}, #f5d98a)`, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>The Complete 2025 Guide</span>
          </h1>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: 16, marginTop: 28 }}>
              {[
                ...
                <div key={s.label} style={{ textAlign: 'center', background: C.elevated, borderRadius: 10, padding: '16px 12px' }}>
                  <div style={{ fontFamily: syne, fontWeight: 900, fontSize: 24, color: C.gold }}>{s.value}</div>
