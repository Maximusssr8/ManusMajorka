      ...
      <nav style={{ position: 'sticky', top: 0, zIndex: 50, background: 'rgba(250,250,250,0.98)', backdropFilter: 'blur(12px)', borderBottom: '1px solid #E5E7EB' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 24px', height: 60, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <div style={{ display: 'flex', gap: 20, alignItems: 'center' }}>
            ...
            <Link href="/sign-in" style={{ background: `linear-gradient(135deg, ${C.gold}, #2563EB)`, color: 'white', fontFamily: syne, fontWeight: 700, fontSize: 13, padding: '8px 18px', borderRadius: 8, textDecoration: 'none' }}>Start Free →</Link>
          </div>
        </div>
      </nav>
      ...
      <main style={{ maxWidth: 1100, margin: '0 auto', padding: '0 24px' }}>
        ...
        <section style={{ padding: '80px 0 60px', textAlign: 'center' }}>
          ...
          <h1 style={{ fontFamily: syne, fontWeight: 800, fontSize: 'clamp(2rem, 5vw, 3.5rem)', lineHeight: 1.1, letterSpacing: '-0.03em', marginBottom: 20 }}>
            ...
            <span style={{ background: `linear-gradient(135deg, ${C.gold}, #93C5FD)`, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' as const, color: '#3B82F6' }}>Dropship in Australia</span> in 2026
          </h1>
          ...
          <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link href="/sign-in" style={{ background: `linear-gradient(135deg, ${C.gold}, #2563EB)`, color: 'white', fontFamily: syne, fontWeight: 800, fontSize: 16, padding: '16px 40px', borderRadius: 12, textDecoration: 'none', boxShadow: `0 0 40px rgba(59,130,246,0.3)` }}>
        ...
        <section style={{ textAlign: 'center', padding: '60px 0 80px' }}>
          ...
          <Link href="/sign-in" style={{ background: `linear-gradient(135deg, ${C.gold}, #2563EB)`, color: 'white', fontFamily: syne, fontWeight: 800, fontSize: 17, padding: '18px 48px', borderRadius: 14, textDecoration: 'none', display: 'inline-block', boxShadow: `0 0 50px rgba(59,130,246,0.35)` }}>
            Start Finding Products Free →
          </Link>
