      ...
      <main style={{ maxWidth: 1100, margin: '0 auto', padding: '0 24px' }}>
        ...
        <section style={{ padding: '80px 0 60px', textAlign: 'center' }}>
          ...
          <h1 style={{ fontFamily: syne, fontWeight: 800, fontSize: 'clamp(2rem, 5vw, 3.5rem)', lineHeight: 1.1, letterSpacing: '-0.03em', marginBottom: 20 }}>
            ...
            <span style={{ background: `linear-gradient(135deg, ${C.gold}, #A5B4FC)`, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' as const, color: '#4f8ef7' }}>Dropship in Australia</span> in 2026
          </h1>
          ...
          <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link href="/sign-in" style={{ background: `linear-gradient(135deg, ${C.gold}, #3B82F6)`, color: 'white', fontFamily: syne, fontWeight: 800, fontSize: 16, padding: '16px 40px', borderRadius: 12, textDecoration: 'none', boxShadow: `0 0 40px rgba(79,142,247,0.3)` }}>
        ...
        <section style={{ textAlign: 'center', padding: '60px 0 80px' }}>
          ...
          <Link href="/sign-in" style={{ background: `linear-gradient(135deg, ${C.gold}, #3B82F6)`, color: 'white', fontFamily: syne, fontWeight: 800, fontSize: 17, padding: '18px 48px', borderRadius: 14, textDecoration: 'none', display: 'inline-block', boxShadow: `0 0 50px rgba(79,142,247,0.35)` }}>
            Start Finding Products Free →
          </Link>
