    ...
    >
      ...
      <aside
        ...
        style={{
          ...
          borderRight: '1px solid var(--surface-border, rgba(59,130,246,0.12))',
        }}
      >
        {/* Header */}
        <div
          className="flex items-center gap-2.5 px-4 py-4"
          style={{ borderBottom: '1px solid var(--surface-border, rgba(59,130,246,0.12))' }}
        >
          <div
            ...
            return (
              ...
              >
                <ChevronRight
                  ...
                  style={{
                    flexShrink: 0,
                    color: active ? '#3B82F6' : 'transparent',
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8 sm:py-10">
          ...
          <div className="md:hidden mb-6">
            <select
              ...
              style={{
                background: 'var(--surface-1, #FFFFFF)',
                border: '1px solid var(--surface-border, rgba(59,130,246,0.12))',
                color: '#F8FAFC',
                fontFamily: 'DM Sans, sans-serif',
              }}
            >
          ...
          <div className="mb-8">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span
                ...
                style={{ color: '#3B82F6', fontFamily: "'Bricolage Grotesque', sans-serif", fontSize: 10 }}
              >
                Knowledge Base
              </span>
            </div>
...
function InlineMarkdown({ text }: { text: string }) {
  ...
  while (remaining.length > 0) {
    ...
    if (type === 'bold') {
      ...
      parts.push(
        <a key={key++} href={linkUrl} style={{ color: '#3B82F6', fontWeight: 600, textDecoration: 'none' }}
