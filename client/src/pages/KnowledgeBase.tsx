    ...
    >
      ...
      <aside
        ...
        style={{
          ...
          borderRight: '1px solid var(--surface-border, rgba(79,142,247,0.12))',
        }}
      >
        {/* Header */}
        <div
          className="flex items-center gap-2.5 px-4 py-4"
          style={{ borderBottom: '1px solid var(--surface-border, rgba(79,142,247,0.12))' }}
        >
          <div
            className="w-7 h-7 rounded-lg flex items-center justify-center flex-shrink-0"
            style={{ background: 'rgba(79,142,247,0.12)' }}
          >
            <BookOpen size={14} style={{ color: '#4f8ef7' }} />
          </div>
          <span
            ...
            return (
              ...
              >
                <ChevronRight
                  ...
                  style={{
                    flexShrink: 0,
                    color: active ? '#4f8ef7' : 'transparent',
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8 sm:py-10">
          ...
          <div className="md:hidden mb-6">
            <select
              ...
              style={{
                background: 'var(--surface-1, #FFFFFF)',
                border: '1px solid var(--surface-border, rgba(79,142,247,0.12))',
                color: '#F8FAFC',
                fontFamily: 'DM Sans, sans-serif',
              }}
            >
          ...
          <div className="mb-8">
            <div className="flex items-center gap-2 mb-3">
              <div
                ...
                style={{ background: 'rgba(79,142,247,0.12)' }}
              >
                <BookOpen size={12} style={{ color: '#4f8ef7' }} />
              </div>
              <span
                className="text-xs uppercase tracking-widest font-bold"
                style={{ color: '#4f8ef7', fontFamily: "'Syne', sans-serif", fontSize: 10 }}
              >
                Knowledge Base
              </span>
            </div>
...
function InlineMarkdown({ text }: { text: string }) {
  ...
  while (remaining.length > 0) {
    ...
    if (type === 'bold') {
      ...
      parts.push(
        <a key={key++} href={linkUrl} style={{ color: '#4f8ef7', fontWeight: 600, textDecoration: 'none' }}
