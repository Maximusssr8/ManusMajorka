...
import { Check, Copy, ExternalLink, Loader2, RefreshCw, Truck } from 'lucide-react';
            ...
            {supplier.searchTerms.map((term, i) => (
              ...
              >
                ...
                <div className="flex items-center gap-1">
                  <CopyBtn text={term} />
                  <a
                    href={`https://www.${supplier.platform.toLowerCase()}.com/search?q=${encodeURIComponent(term)}`}
                    target="_blank"
