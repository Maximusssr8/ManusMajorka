    ...
    <div style={{ background: C.bg, minHeight: "100vh", color: C.text, fontFamily: dm }}>
      ...
      <main style={{ maxWidth: 760, margin: "0 auto", padding: "64px 24px 96px" }}>
        ...
        <div style={{ marginBottom: 48 }}>
          <p style={{ color: C.gold, fontSize: 13, fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: 12 }}>
            Legal
          </p>
          <h1 style={{ fontFamily: syne, fontWeight: 800, fontSize: 40, lineHeight: 1.15, marginBottom: 16 }}>
            Privacy Policy
          </h1>
          ...
          <p style={{ color: C.secondary, fontSize: 15, lineHeight: 1.6, marginTop: 12 }}>
            ...
            explains how we collect, use, and safeguard your information when you use our platform at{" "}
            <span style={{ color: C.gold }}>majorka.ai</span>.
          </p>
        </div>
        ...
        <div style={{ textAlign: "center" }}>
          <p style={{ color: C.secondary, fontSize: 13 }}>
            © 2026 Majorka. All rights reserved.
          </p>
          <div style={{ display: "flex", justifyContent: "center", gap: 24, marginTop: 12 }}>
            ...
            <Link href="/privacy">
              <span style={{ color: C.gold, fontSize: 13, cursor: "pointer" }}>
                Privacy Policy
              </span>
            </Link>
          </div>
