...
const SEEDED_PRODUCTS: WinningProduct[] = [
  ...
  { id: 'b4', product_title: 'Ice Facial Roller (Stainless)', category: 'Beauty & Skincare', platform: 'TikTok Shop', price_aud: 28, sold_count: 19800, winning_score: 74, trend: 'growing', competition_level: 'low', au_relevance: 86, est_daily_revenue_aud: 1300, units_per_day: 46, why_winning: 'Cold skincare trend exploding; stainless steel positions as premium over plastic.', ad_angle: 'Your face will thank you for 60 seconds of this every morning.', image_url: 'https://images.pexels.com/photos/3985360/pexels-photo-3985360.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 39000, revenue_growth_pct: 73, platforms: ['TikTok Shop'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  ...
  { id: 'f8', product_title: 'Speed Jump Rope (Ball Bearings)', category: 'Fitness & Sports', platform: 'TikTok Shop', price_aud: 27, sold_count: 22400, winning_score: 74, trend: 'growing', competition_level: 'low', au_relevance: 87, est_daily_revenue_aud: 1200, units_per_day: 44, why_winning: 'Crossfit + boxing trends keep this perennially relevant. Lowest barrier home cardio.', ad_angle: '10 minutes, 100 calories. The only cardio equipment you will ever need.', image_url: 'https://images.pexels.com/photos/4720258/pexels-photo-4720258.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 36000, revenue_growth_pct: 29, platforms: ['TikTok Shop'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  // ── Tech & Gadgets ─────────────────────────────────────────────────────────
