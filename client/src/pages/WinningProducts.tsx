...
import { getScoreStyle } from '@/lib/calculations';
...
const SEEDED_PRODUCTS: WinningProduct[] = [
  { id: 's1', product_title: 'LED Therapy Face Mask', category: 'Health & Beauty', platform: 'TikTok Shop', price_aud: 89, sold_count: 3240, winning_score: 94, trend: 'exploding', competition_level: 'low', au_relevance: 92, est_daily_revenue_aud: 2800, units_per_day: 31, why_winning: 'Viral TikTok skincare trend — AU women 25–44 spending big on at-home spa tech.', ad_angle: 'Ditch the dermatologist waitlist. Get clinic-grade skin in 10 minutes from your couch.', image_url: 'https://images.pexels.com/photos/3985360/pexels-photo-3985360.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 's2', product_title: 'Posture Corrector Pro', category: 'Health & Beauty', platform: 'TikTok Shop', price_aud: 49, sold_count: 5100, winning_score: 88, trend: 'exploding', competition_level: 'low', au_relevance: 88, est_daily_revenue_aud: 1960, units_per_day: 40, why_winning: 'WFH culture driving neck/back pain in AU. Solves real problem with instant relief angle.', ad_angle: '8 hours at a desk destroyed my posture. This fixed it in 2 weeks.', image_url: 'https://images.pexels.com/photos/4498603/pexels-photo-4498603.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 's3', product_title: 'Portable Neck Fan', category: 'Tech', platform: 'TikTok Shop', price_aud: 39, sold_count: 7800, winning_score: 85, trend: 'growing', competition_level: 'medium', au_relevance: 96, est_daily_revenue_aud: 1560, units_per_day: 40, why_winning: 'Summers getting hotter in AU. Seasonal product with strong repeat buyer potential.', ad_angle: 'Queensland summer hits different when you stop sweating through your work shirt.', image_url: 'https://images.pexels.com/photos/3783471/pexels-photo-3783471.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 's4', product_title: 'Pet Self-Cleaning Slicker Brush', category: 'Pet', platform: 'TikTok Shop', price_aud: 34, sold_count: 9200, winning_score: 82, trend: 'growing', competition_level: 'low', au_relevance: 90, est_daily_revenue_aud: 1190, units_per_day: 35, why_winning: 'AU has one of the highest pet ownership rates. Solves universal pain: dog hair everywhere.', ad_angle: 'My golden retriever was destroying my furniture. This self-cleaning brush changed everything.', image_url: 'https://images.pexels.com/photos/1805164/pexels-photo-1805164.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 's5', product_title: 'Resistance Bands Set (11pc)', category: 'Fitness', platform: 'TikTok Shop', price_aud: 45, sold_count: 6700, winning_score: 79, trend: 'growing', competition_level: 'medium', au_relevance: 85, est_daily_revenue_aud: 1350, units_per_day: 30, why_winning: 'Home gym trend still strong. Low ticket, high volume. Gym minimalists love this.', ad_angle: 'Cancel your $60/month gym membership. This $45 kit does everything you need.', image_url: 'https://images.pexels.com/photos/4162487/pexels-photo-4162487.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 's6', product_title: 'Fridge Organiser Bins Set', category: 'Home & Kitchen', platform: 'TikTok Shop', price_aud: 38, sold_count: 12100, winning_score: 76, trend: 'stable', competition_level: 'medium', au_relevance: 82, est_daily_revenue_aud: 1140, units_per_day: 30, why_winning: 'Evergreen product. Strong "satisfying clean fridge" video content potential.', ad_angle: 'Spent 15 mins organising my fridge. Saved $200 in food waste this month.', image_url: 'https://images.pexels.com/photos/3990359/pexels-photo-3990359.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 's7', product_title: 'UV Phone Sanitiser Box', category: 'Tech', platform: 'TikTok Shop', price_aud: 59, sold_count: 4300, winning_score: 73, trend: 'growing', competition_level: 'low', au_relevance: 87, est_daily_revenue_aud: 1180, units_per_day: 20, why_winning: 'Health-conscious AU market. Great gift product. Dual use as wireless charger.', ad_angle: 'Your phone has more bacteria than a toilet seat. This kills 99.9% in 5 minutes.', image_url: 'https://images.pexels.com/photos/1181244/pexels-photo-1181244.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 's8', product_title: 'Anti-Gravity Wall Planter', category: 'Home & Kitchen', platform: 'TikTok Shop', price_aud: 29, sold_count: 8900, winning_score: 71, trend: 'stable', competition_level: 'low', au_relevance: 80, est_daily_revenue_aud: 870, units_per_day: 30, why_winning: 'Plant parent culture massive in AU. Tiny apartments need space-saving solutions.', ad_angle: 'Turn your blank wall into a garden. Perfect for renters — no drilling needed.', image_url: 'https://images.pexels.com/photos/1084199/pexels-photo-1084199.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 's9', product_title: 'Compression Knee Brace (Pair)', category: 'Health & Beauty', platform: 'TikTok Shop', price_aud: 44, sold_count: 5600, winning_score: 69, trend: 'stable', competition_level: 'medium', au_relevance: 83, est_daily_revenue_aud: 880, units_per_day: 20, why_winning: 'Ageing AU population. Runners and gym-goers. Strong pain-point angle.', ad_angle: 'Finished a half marathon with zero knee pain. Finally found something that actually works.', image_url: 'https://images.pexels.com/photos/863926/pexels-photo-863926.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 's10', product_title: 'Waterproof Dog Raincoat', category: 'Pet', platform: 'TikTok Shop', price_aud: 29, sold_count: 7200, winning_score: 67, trend: 'growing', competition_level: 'low', au_relevance: 88, est_daily_revenue_aud: 870, units_per_day: 30, why_winning: 'Strong gifting category. Cute product = viral UGC. Low competition from AU retailers.', ad_angle: 'My dog refused to walk in rain. Now she sprints to the door when she sees her raincoat.', image_url: 'https://images.pexels.com/photos/1805164/pexels-photo-1805164.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 's11', product_title: 'Electric Scalp Massager', category: 'Health & Beauty', platform: 'TikTok Shop', price_aud: 39, sold_count: 4100, winning_score: 65, trend: 'growing', competition_level: 'low', au_relevance: 78, est_daily_revenue_aud: 780, units_per_day: 20, why_winning: 'Stress relief and hair growth niche growing fast. Strong before/after content angle.', ad_angle: 'Used this for 30 days. My hairdresser asked what changed. Stress-relief bonus too.', image_url: 'https://images.pexels.com/photos/3993449/pexels-photo-3993449.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 's12', product_title: 'Stainless Meal Prep Containers (5pk)', category: 'Home & Kitchen', platform: 'TikTok Shop', price_aud: 52, sold_count: 6300, winning_score: 63, trend: 'stable', competition_level: 'medium', au_relevance: 79, est_daily_revenue_aud: 624, units_per_day: 12, why_winning: 'Meal prep trend huge with AU health-conscious millennials. Eco angle plays well.', ad_angle: 'Ditch plastic. Meal prepped Sunday, ate healthy all week, saved $90 on takeaway.', image_url: 'https://images.pexels.com/photos/3990359/pexels-photo-3990359.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 's13', product_title: 'Portable Jump Rope Counter', category: 'Fitness', platform: 'TikTok Shop', price_aud: 24, sold_count: 9800, winning_score: 61, trend: 'growing', competition_level: 'low', au_relevance: 77, est_daily_revenue_aud: 720, units_per_day: 30, why_winning: 'Cardio at home. Low price point = impulse buy. Auto-counter solves real pain.', ad_angle: 'Track your jumps automatically. No math, no excuses, just burn.', image_url: 'https://images.pexels.com/photos/4720258/pexels-photo-4720258.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 's14', product_title: 'Blue Light Blocking Glasses', category: 'Tech', platform: 'TikTok Shop', price_aud: 34, sold_count: 11200, winning_score: 58, trend: 'stable', competition_level: 'high', au_relevance: 76, est_daily_revenue_aud: 680, units_per_day: 20, why_winning: 'Screen fatigue growing. Low cost gift item. But high competition — needs strong angle.', ad_angle: 'My headaches disappeared after 3 days. My boss thought I got better sleep. I did.', image_url: 'https://images.pexels.com/photos/1029757/pexels-photo-1029757.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 's15', product_title: 'Bamboo Charging Organiser Dock', category: 'Tech', platform: 'TikTok Shop', price_aud: 65, sold_count: 3800, winning_score: 56, trend: 'stable', competition_level: 'medium', au_relevance: 74, est_daily_revenue_aud: 650, units_per_day: 10, why_winning: 'Eco-conscious AU buyers. Desk setups content is huge. Great gift for Christmas.', ad_angle: 'Cleared my bedside table chaos with one purchase. Charges 4 devices overnight.', image_url: 'https://images.pexels.com/photos/1029757/pexels-photo-1029757.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  // ── Health & Wellness ──────────────────────────────────────────────────────
  { id: 'h1', product_title: 'Red Light Therapy Wand', category: 'Health & Wellness', platform: 'TikTok Shop', price_aud: 89, sold_count: 14200, winning_score: 88, trend: 'exploding', competition_level: 'low', au_relevance: 87, est_daily_revenue_aud: 3200, units_per_day: 36, why_winning: 'Dermatologist-endorsed trend going viral across AU beauty communities.', ad_angle: 'Get rid of fine lines in 10 minutes a day — no needles, no clinic.', image_url: 'https://images.pexels.com/photos/3997993/pexels-photo-3997993.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 96000, revenue_growth_pct: 142, platforms: ['TikTok Shop'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'h2', product_title: 'Magnesium Sleep Spray', category: 'Health & Wellness', platform: 'Shopify', price_aud: 34, sold_count: 9800, winning_score: 82, trend: 'exploding', competition_level: 'low', au_relevance: 91, est_daily_revenue_aud: 1800, units_per_day: 53, why_winning: 'Sleep anxiety epidemic in AU driving massive demand for natural sleep aids.', ad_angle: 'Spray it on. Sleep in 20 minutes. No pills, no groggy mornings.', image_url: 'https://images.pexels.com/photos/3985360/pexels-photo-3985360.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 54000, revenue_growth_pct: 89, platforms: ['Shopify', 'TikTok Shop'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'h3', product_title: 'Acupressure Mat & Pillow Set', category: 'Health & Wellness', platform: 'Amazon AU', price_aud: 49, sold_count: 11600, winning_score: 79, trend: 'growing', competition_level: 'medium', au_relevance: 85, est_daily_revenue_aud: 2100, units_per_day: 43, why_winning: 'Back pain is endemic in desk-worker AU culture and this solves it cheaply.', ad_angle: 'Lie on this for 20 minutes and watch years of back pain disappear.', image_url: 'https://images.pexels.com/photos/3985360/pexels-photo-3985360.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 63000, revenue_growth_pct: 45, platforms: ['Amazon AU'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'h4', product_title: 'Cold Plunge Inflatable Tub', category: 'Health & Wellness', platform: 'Shopify', price_aud: 199, sold_count: 3400, winning_score: 85, trend: 'exploding', competition_level: 'low', au_relevance: 88, est_daily_revenue_aud: 2800, units_per_day: 14, why_winning: 'Cold therapy trend exploded post-Huberman. High AOV, excellent margins.', ad_angle: 'The $500 cold plunge you can set up in your backyard for $199.', image_url: 'https://images.pexels.com/photos/3985360/pexels-photo-3985360.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 84000, revenue_growth_pct: 210, platforms: ['Shopify'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'h5', product_title: 'Posture Corrector Brace', category: 'Health & Wellness', platform: 'TikTok Shop', price_aud: 39, sold_count: 18400, winning_score: 76, trend: 'growing', competition_level: 'medium', au_relevance: 90, est_daily_revenue_aud: 1600, units_per_day: 41, why_winning: 'Work-from-home culture created a generation of bad posture. Huge repeat purchase.', ad_angle: '8 hours at your desk ruining your posture. Fix it in 2 weeks.', image_url: 'https://images.pexels.com/photos/4498603/pexels-photo-4498603.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 48000, revenue_growth_pct: 38, platforms: ['TikTok Shop', 'Amazon AU'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'h6', product_title: 'Jade Facial Roller Set', category: 'Health & Wellness', platform: 'TikTok Shop', price_aud: 27, sold_count: 22100, winning_score: 71, trend: 'stable', competition_level: 'medium', au_relevance: 84, est_daily_revenue_aud: 1200, units_per_day: 44, why_winning: 'Skincare ritual products have high gift potential and strong repeat purchase.', ad_angle: 'Your 5-minute morning ritual for glowing skin. Depuff in days.', image_url: 'https://images.pexels.com/photos/3822622/pexels-photo-3822622.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 36000, revenue_growth_pct: 22, platforms: ['TikTok Shop'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'h7', product_title: 'PEMF Therapy Mat', category: 'Health & Wellness', platform: 'Shopify', price_aud: 299, sold_count: 1800, winning_score: 83, trend: 'growing', competition_level: 'low', au_relevance: 80, est_daily_revenue_aud: 2900, units_per_day: 10, why_winning: 'Premium biohacking device with $200+ margins and no major AU competitor.', ad_angle: 'The recovery tool elite athletes use. Now available for everyone.', image_url: 'https://images.pexels.com/photos/3985360/pexels-photo-3985360.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 87000, revenue_growth_pct: 67, platforms: ['Shopify'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'h8', product_title: 'EMF Protection Phone Case', category: 'Health & Wellness', platform: 'Shopify', price_aud: 54, sold_count: 7200, winning_score: 73, trend: 'growing', competition_level: 'low', au_relevance: 86, est_daily_revenue_aud: 1400, units_per_day: 26, why_winning: 'Health-conscious AU parents driving this niche; fear-based purchase = high conv.', ad_angle: 'Your phone radiates all day. This case blocks 99% of EMF. Peace of mind, $54.', image_url: 'https://images.pexels.com/photos/3985360/pexels-photo-3985360.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 42000, revenue_growth_pct: 55, platforms: ['Shopify'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'h9', product_title: 'Resistance Band Set (11pc)', category: 'Health & Wellness', platform: 'Amazon AU', price_aud: 32, sold_count: 28600, winning_score: 68, trend: 'stable', competition_level: 'high', au_relevance: 93, est_daily_revenue_aud: 1100, units_per_day: 34, why_winning: 'Perennial bestseller; pivot to niche bundles (pilates, physio) reduces competition.', ad_angle: 'Full gym workout, zero equipment. 11 bands, infinite possibilities.', image_url: 'https://images.pexels.com/photos/3985360/pexels-photo-3985360.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 33000, revenue_growth_pct: 12, platforms: ['Amazon AU', 'eBay AU'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'h10', product_title: 'Grounding Mat (Earthing)', category: 'Health & Wellness', platform: 'Shopify', price_aud: 79, sold_count: 4600, winning_score: 78, trend: 'exploding', competition_level: 'low', au_relevance: 82, est_daily_revenue_aud: 1900, units_per_day: 24, why_winning: 'Grounding trend from wellness influencers with almost zero AU direct competition.', ad_angle: 'Walk barefoot all day without leaving your desk. Sleep better tonight.', image_url: 'https://images.pexels.com/photos/3985360/pexels-photo-3985360.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 57000, revenue_growth_pct: 178, platforms: ['Shopify'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  // ── Beauty & Skincare ──────────────────────────────────────────────────────
  { id: 'b1', product_title: 'LED Teeth Whitening Kit', category: 'Beauty & Skincare', platform: 'TikTok Shop', price_aud: 49, sold_count: 31200, winning_score: 86, trend: 'exploding', competition_level: 'medium', au_relevance: 95, est_daily_revenue_aud: 3600, units_per_day: 73, why_winning: 'Massive vanity market in AU with zero health risk angle and strong UGC potential.', ad_angle: '14 shades whiter in 7 days. Dentist results at 1/50th of the cost.', image_url: 'https://images.pexels.com/photos/3762453/pexels-photo-3762453.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 108000, revenue_growth_pct: 95, platforms: ['TikTok Shop'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'b2', product_title: 'Gua Sha Facial Tool (Rose Quartz)', category: 'Beauty & Skincare', platform: 'TikTok Shop', price_aud: 22, sold_count: 44500, winning_score: 78, trend: 'stable', competition_level: 'high', au_relevance: 88, est_daily_revenue_aud: 1500, units_per_day: 68, why_winning: 'High gift purchase rate; bundle with oils for 3x AOV lift.', ad_angle: 'The ancient face lift that is absolutely everywhere right now.', image_url: 'https://images.pexels.com/photos/3985360/pexels-photo-3985360.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 45000, revenue_growth_pct: 18, platforms: ['TikTok Shop', 'eBay AU'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'b3', product_title: 'Hydrocolloid Patch Set (360pk)', category: 'Beauty & Skincare', platform: 'Amazon AU', price_aud: 19, sold_count: 56000, winning_score: 81, trend: 'growing', competition_level: 'medium', au_relevance: 96, est_daily_revenue_aud: 1800, units_per_day: 95, why_winning: 'TikTok acne community is massive in AU; low price = impulse buy, high repeat.', ad_angle: 'Pimples gone by morning. 360 patches, $19. The math is too good.', image_url: 'https://images.pexels.com/photos/3985360/pexels-photo-3985360.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 54000, revenue_growth_pct: 62, platforms: ['Amazon AU', 'TikTok Shop'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'b4', product_title: 'Ice Facial Roller (Stainless)', category: 'Beauty & Skincare', platform: 'TikTok Shop', price_aud: 28, sold_count: 19800, winning_score: 76, trend: 'growing', competition_level: 'low', au_relevance: 86, est_daily_revenue_aud: 1300, units_per_day: 46, why_winning: 'Cold skincare trend exploding; stainless steel positions as premium over plastic.', ad_angle: 'Your face will thank you for 60 seconds of this every morning.', image_url: 'https://images.pexels.com/photos/3985360/pexels-photo-3985360.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 39000, revenue_growth_pct: 73, platforms: ['TikTok Shop'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'b5', product_title: 'Nano Facial Mister', category: 'Beauty & Skincare', platform: 'Shopify', price_aud: 44, sold_count: 12300, winning_score: 76, trend: 'growing', competition_level: 'medium', au_relevance: 90, est_daily_revenue_aud: 1500, units_per_day: 34, why_winning: 'Hydration-focused skincare is the #1 trend in AU beauty. Satisfying to use on camera.', ad_angle: 'Rehydrate your skin in 30 seconds. Works over makeup.', image_url: 'https://images.pexels.com/photos/3985360/pexels-photo-3985360.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 45000, revenue_growth_pct: 44, platforms: ['Shopify', 'TikTok Shop'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'b6', product_title: 'Blackhead Vacuum Remover', category: 'Beauty & Skincare', platform: 'TikTok Shop', price_aud: 38, sold_count: 23700, winning_score: 79, trend: 'stable', competition_level: 'medium', au_relevance: 87, est_daily_revenue_aud: 1700, units_per_day: 45, why_winning: 'Satisfying "gross" content drives organic reach; before/after videos go viral.', ad_angle: 'Warning: You will not be able to stop watching your pores get cleaned.', image_url: 'https://images.pexels.com/photos/3373723/pexels-photo-3373723.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 51000, revenue_growth_pct: 29, platforms: ['TikTok Shop', 'Amazon AU'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'b7', product_title: 'Professional Hair Scalp Massager', category: 'Beauty & Skincare', platform: 'Amazon AU', price_aud: 24, sold_count: 34100, winning_score: 72, trend: 'growing', competition_level: 'medium', au_relevance: 91, est_daily_revenue_aud: 1200, units_per_day: 50, why_winning: 'Hair loss anxiety + self-care trend = massive crossover audience.', ad_angle: 'Regrow your hair while you shower. 5 minutes, $24, life-changing results.', image_url: 'https://images.pexels.com/photos/3993449/pexels-photo-3993449.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 36000, revenue_growth_pct: 41, platforms: ['Amazon AU', 'TikTok Shop'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'b8', product_title: 'Collagen Eye Patches (60 pairs)', category: 'Beauty & Skincare', platform: 'Shopify', price_aud: 35, sold_count: 16400, winning_score: 75, trend: 'growing', competition_level: 'medium', au_relevance: 89, est_daily_revenue_aud: 1400, units_per_day: 40, why_winning: 'Under-eye care is the #1 skincare concern in AU women 30+; strong subscription potential.', ad_angle: 'Wear these while you sleep. Wake up looking 5 years younger.', image_url: 'https://images.pexels.com/photos/3621240/pexels-photo-3621240.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 42000, revenue_growth_pct: 48, platforms: ['Shopify'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  // ── Home & Kitchen ─────────────────────────────────────────────────────────
  { id: 'k1', product_title: 'Smart Herb Garden Kit', category: 'Home & Kitchen', platform: 'Shopify', price_aud: 79, sold_count: 8900, winning_score: 84, trend: 'exploding', competition_level: 'low', au_relevance: 93, est_daily_revenue_aud: 2400, units_per_day: 30, why_winning: 'Cost of living crisis making AU households grow their own food.', ad_angle: 'Fresh basil, mint, and chilli growing on your kitchen bench. Zero effort.', image_url: 'https://images.pexels.com/photos/4751978/pexels-photo-4751978.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 72000, revenue_growth_pct: 134, platforms: ['Shopify', 'Amazon AU'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'k2', product_title: 'Beeswax Food Wraps (Set of 4)', category: 'Home & Kitchen', platform: 'Amazon AU', price_aud: 29, sold_count: 19600, winning_score: 76, trend: 'growing', competition_level: 'low', au_relevance: 95, est_daily_revenue_aud: 1300, units_per_day: 45, why_winning: 'Eco-conscious AU household trend; excellent gift product; reorders every 12 months.', ad_angle: 'Ditch the plastic wrap forever. These last a year and cost $29.', image_url: 'https://images.pexels.com/photos/3990359/pexels-photo-3990359.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 39000, revenue_growth_pct: 52, platforms: ['Amazon AU', 'eBay AU'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'k3', product_title: 'Portable Blender (USB-C)', category: 'Home & Kitchen', platform: 'TikTok Shop', price_aud: 44, sold_count: 24300, winning_score: 80, trend: 'growing', competition_level: 'medium', au_relevance: 88, est_daily_revenue_aud: 1900, units_per_day: 43, why_winning: 'Gym/health trend + compact apartments = perfect storm. Charges with the same cable as your phone.', ad_angle: 'Protein shake in 30 seconds. Anywhere. Charges with your iPhone cable.', image_url: 'https://images.pexels.com/photos/4397927/pexels-photo-4397927.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 57000, revenue_growth_pct: 61, platforms: ['TikTok Shop', 'Amazon AU'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'k4', product_title: 'Vegetable Chopper 14-in-1', category: 'Home & Kitchen', platform: 'Amazon AU', price_aud: 59, sold_count: 16800, winning_score: 77, trend: 'stable', competition_level: 'medium', au_relevance: 92, est_daily_revenue_aud: 1600, units_per_day: 27, why_winning: 'Meal prep content is huge in AU; this is the centrepiece tool for every kitchen hack video.', ad_angle: 'Prep a week of meals in 20 minutes. One tool, 14 cuts.', image_url: 'https://images.pexels.com/photos/3990359/pexels-photo-3990359.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 48000, revenue_growth_pct: 28, platforms: ['Amazon AU'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'k5', product_title: 'Weighted Blanket (7kg)', category: 'Home & Kitchen', platform: 'Shopify', price_aud: 89, sold_count: 7200, winning_score: 73, trend: 'stable', competition_level: 'medium', au_relevance: 90, est_daily_revenue_aud: 1400, units_per_day: 16, why_winning: 'Anxiety/sleep market continues to grow; high AOV, good margins.', ad_angle: 'The blanket that feels like a hug. Sleep 2 hours deeper, guaranteed.', image_url: 'https://images.pexels.com/photos/3771069/pexels-photo-3771069.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 42000, revenue_growth_pct: 19, platforms: ['Shopify', 'Amazon AU'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'k6', product_title: 'Self-Watering Plant Pot Set', category: 'Home & Kitchen', platform: 'Amazon AU', price_aud: 38, sold_count: 12400, winning_score: 71, trend: 'growing', competition_level: 'low', au_relevance: 88, est_daily_revenue_aud: 1100, units_per_day: 29, why_winning: 'Plant parent trend + apartment living + forgetful millennials = perfect product.', ad_angle: 'Never kill a plant again. The pot waters itself for up to 2 weeks.', image_url: 'https://images.pexels.com/photos/3990359/pexels-photo-3990359.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 33000, revenue_growth_pct: 34, platforms: ['Amazon AU', 'eBay AU'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'k7', product_title: 'Collapsible Silicone Storage Bags (8pk)', category: 'Home & Kitchen', platform: 'Amazon AU', price_aud: 34, sold_count: 21000, winning_score: 72, trend: 'stable', competition_level: 'medium', au_relevance: 94, est_daily_revenue_aud: 1200, units_per_day: 35, why_winning: 'Eco-packaging laws in AU making reusable bags more urgent.', ad_angle: 'Replace 500 zip-locks a year with these. Better for you, better for the planet.', image_url: 'https://images.pexels.com/photos/3990359/pexels-photo-3990359.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 36000, revenue_growth_pct: 24, platforms: ['Amazon AU'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'k8', product_title: 'Mini Hot Glue Gun Set', category: 'Home & Kitchen', platform: 'TikTok Shop', price_aud: 24, sold_count: 18900, winning_score: 69, trend: 'growing', competition_level: 'low', au_relevance: 85, est_daily_revenue_aud: 1000, units_per_day: 42, why_winning: 'DIY/craft explosion on AU TikTok; this is in every "apartment DIY" video.', ad_angle: '100 DIY projects start with this $24 tool. Go make something.', image_url: 'https://images.pexels.com/photos/3990359/pexels-photo-3990359.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 30000, revenue_growth_pct: 47, platforms: ['TikTok Shop'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  // ── Fitness & Sports ───────────────────────────────────────────────────────
  { id: 'f1', product_title: 'Massage Gun Pro (5 heads)', category: 'Fitness & Sports', platform: 'TikTok Shop', price_aud: 79, sold_count: 19400, winning_score: 84, trend: 'growing', competition_level: 'medium', au_relevance: 90, est_daily_revenue_aud: 2600, units_per_day: 33, why_winning: 'Recovery is the new fitness; everyone wants Theragun results without the Theragun price.', ad_angle: 'A $800 Theragun for $79. Same motor, same results, $721 saved.', image_url: 'https://images.pexels.com/photos/3764568/pexels-photo-3764568.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 78000, revenue_growth_pct: 48, platforms: ['TikTok Shop', 'Amazon AU'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'f2', product_title: 'Ab Roller Wheel with Knee Pad', category: 'Fitness & Sports', platform: 'Amazon AU', price_aud: 29, sold_count: 31200, winning_score: 72, trend: 'stable', competition_level: 'high', au_relevance: 92, est_daily_revenue_aud: 1100, units_per_day: 38, why_winning: 'Core training is universal; differentiate with the "6-pack in 30 days" angle.', ad_angle: '30 seconds a day. 30 days. A core you are actually proud of.', image_url: 'https://images.pexels.com/photos/841130/pexels-photo-841130.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 33000, revenue_growth_pct: 14, platforms: ['Amazon AU'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'f3', product_title: 'Adjustable Dumbbell (2-24kg)', category: 'Fitness & Sports', platform: 'Shopify', price_aud: 149, sold_count: 6800, winning_score: 81, trend: 'growing', competition_level: 'medium', au_relevance: 88, est_daily_revenue_aud: 2200, units_per_day: 15, why_winning: 'Gym memberships declining post-COVID; home gym build-out is a $500B global market.', ad_angle: 'Replace a $3,000 dumbbell rack for $149. Adjusts in 2 seconds.', image_url: 'https://images.pexels.com/photos/4162487/pexels-photo-4162487.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 66000, revenue_growth_pct: 56, platforms: ['Shopify', 'Amazon AU'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'f4', product_title: 'Booty Band Set (5 levels)', category: 'Fitness & Sports', platform: 'TikTok Shop', price_aud: 24, sold_count: 42600, winning_score: 78, trend: 'stable', competition_level: 'high', au_relevance: 91, est_daily_revenue_aud: 1600, units_per_day: 67, why_winning: 'Lower body training dominates AU female fitness content; bundle with leggings for $60+ AOV.', ad_angle: 'The bands every AU fitness creator uses. 5 levels, $24, no excuses.', image_url: 'https://images.pexels.com/photos/4162487/pexels-photo-4162487.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 48000, revenue_growth_pct: 22, platforms: ['TikTok Shop'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'f5', product_title: 'Foam Roller Deep Tissue (45cm)', category: 'Fitness & Sports', platform: 'Amazon AU', price_aud: 34, sold_count: 24800, winning_score: 68, trend: 'stable', competition_level: 'high', au_relevance: 93, est_daily_revenue_aud: 1000, units_per_day: 29, why_winning: 'Recovery staple; bundle play (mat + roller + ball) increases AOV to $89.', ad_angle: 'The physio tool your muscles have been begging for.', image_url: 'https://images.pexels.com/photos/3822906/pexels-photo-3822906.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 30000, revenue_growth_pct: 11, platforms: ['Amazon AU', 'eBay AU'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'f6', product_title: 'Pull-Up Bar (No Drill Doorframe)', category: 'Fitness & Sports', platform: 'Amazon AU', price_aud: 54, sold_count: 13600, winning_score: 75, trend: 'growing', competition_level: 'medium', au_relevance: 89, est_daily_revenue_aud: 1400, units_per_day: 26, why_winning: 'Renters cannot drill; this is the only solution. Perfect for AU apartment dwellers.', ad_angle: 'No drill. No damage. No excuses. Pull-ups in your doorframe tonight.', image_url: 'https://images.pexels.com/photos/1552242/pexels-photo-1552242.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 42000, revenue_growth_pct: 38, platforms: ['Amazon AU'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'f7', product_title: 'Workout Gloves (Wrist Support)', category: 'Fitness & Sports', platform: 'Amazon AU', price_aud: 29, sold_count: 19200, winning_score: 66, trend: 'stable', competition_level: 'high', au_relevance: 88, est_daily_revenue_aud: 900, units_per_day: 31, why_winning: 'Budget gym accessory; differentiate with "injury prevention" angle not aesthetics.', ad_angle: 'Stop tearing your hands. Start lifting heavier. $29 and problem solved.', image_url: 'https://images.pexels.com/photos/4162487/pexels-photo-4162487.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 27000, revenue_growth_pct: 8, platforms: ['Amazon AU'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'f8', product_title: 'Speed Jump Rope (Ball Bearings)', category: 'Fitness & Sports', platform: 'TikTok Shop', price_aud: 27, sold_count: 22400, winning_score: 75, trend: 'growing', competition_level: 'low', au_relevance: 87, est_daily_revenue_aud: 1200, units_per_day: 44, why_winning: 'Crossfit + boxing trends keep this perennially relevant. Lowest barrier home cardio.', ad_angle: '10 minutes, 100 calories. The only cardio equipment you will ever need.', image_url: 'https://images.pexels.com/photos/4720258/pexels-photo-4720258.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 36000, revenue_growth_pct: 29, platforms: ['TikTok Shop'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  // ── Tech & Gadgets ─────────────────────────────────────────────────────────
  { id: 't1', product_title: 'Magnetic Wireless Charger Stand (3-in-1)', category: 'Tech & Gadgets', platform: 'Amazon AU', price_aud: 59, sold_count: 22800, winning_score: 83, trend: 'growing', competition_level: 'medium', au_relevance: 93, est_daily_revenue_aud: 2400, units_per_day: 41, why_winning: 'Every iPhone 15+ user needs this. No brainer purchase with strong gifting season.', ad_angle: 'Phone, watch, AirPods. One stand. Fully charged every morning.', image_url: 'https://images.pexels.com/photos/4526407/pexels-photo-4526407.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 72000, revenue_growth_pct: 67, platforms: ['Amazon AU', 'TikTok Shop'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 't2', product_title: 'Smart Plug (4-Pack, Wi-Fi)', category: 'Tech & Gadgets', platform: 'Amazon AU', price_aud: 49, sold_count: 18600, winning_score: 77, trend: 'growing', competition_level: 'medium', au_relevance: 91, est_daily_revenue_aud: 1700, units_per_day: 35, why_winning: 'Smart home entry product; everyone buys 4 then comes back for more.', ad_angle: 'Turn your old appliances smart for $49. Works with Alexa and Google.', image_url: 'https://images.pexels.com/photos/1029757/pexels-photo-1029757.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 51000, revenue_growth_pct: 41, platforms: ['Amazon AU', 'eBay AU'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 't3', product_title: 'Portable Solar Power Bank (20000mAh)', category: 'Tech & Gadgets', platform: 'Amazon AU', price_aud: 69, sold_count: 11400, winning_score: 79, trend: 'growing', competition_level: 'medium', au_relevance: 95, est_daily_revenue_aud: 1900, units_per_day: 28, why_winning: 'AU outdoor culture makes solar chargers essential; camping/hiking audience.', ad_angle: 'Never run out of battery on a hike again. Charges off the sun.', image_url: 'https://images.pexels.com/photos/1029757/pexels-photo-1029757.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 57000, revenue_growth_pct: 53, platforms: ['Amazon AU'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 't4', product_title: 'Mini Projector (1080p, 120")', category: 'Tech & Gadgets', platform: 'Shopify', price_aud: 189, sold_count: 4200, winning_score: 80, trend: 'exploding', competition_level: 'low', au_relevance: 87, est_daily_revenue_aud: 2100, units_per_day: 11, why_winning: 'Apartment living means no room for big TVs; projector solves this at $189.', ad_angle: 'A 120-inch cinema in your bedroom. No TV required. $189.', image_url: 'https://images.pexels.com/photos/1029757/pexels-photo-1029757.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 63000, revenue_growth_pct: 112, platforms: ['Shopify', 'TikTok Shop'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 't5', product_title: 'Cable Management Box (Set of 3)', category: 'Tech & Gadgets', platform: 'Amazon AU', price_aud: 39, sold_count: 14700, winning_score: 69, trend: 'stable', competition_level: 'medium', au_relevance: 90, est_daily_revenue_aud: 1100, units_per_day: 28, why_winning: "Desk setup culture exploded. Everyone's filming their workspace. Cables are the enemy.", ad_angle: 'Hide every cable in your setup for $39. Before: chaos. After: magazine cover.', image_url: 'https://images.pexels.com/photos/1029757/pexels-photo-1029757.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 33000, revenue_growth_pct: 26, platforms: ['Amazon AU'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 't6', product_title: 'Webcam Cover Slider (10pk)', category: 'Tech & Gadgets', platform: 'Amazon AU', price_aud: 14, sold_count: 48000, winning_score: 64, trend: 'stable', competition_level: 'high', au_relevance: 92, est_daily_revenue_aud: 700, units_per_day: 50, why_winning: 'Paranoid about privacy? So is everyone. Tiny AOV but sky-high unit economics.', ad_angle: 'Your laptop camera is always watching. $14 and peace of mind.', image_url: 'https://images.pexels.com/photos/1181244/pexels-photo-1181244.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 21000, revenue_growth_pct: 9, platforms: ['Amazon AU'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 't7', product_title: 'LED Desk Lamp with Wireless Charger', category: 'Tech & Gadgets', platform: 'Amazon AU', price_aud: 79, sold_count: 8900, winning_score: 76, trend: 'growing', competition_level: 'medium', au_relevance: 91, est_daily_revenue_aud: 1600, units_per_day: 20, why_winning: 'Work-from-home setup product; high gifting potential Dec/Jan.', ad_angle: 'The lamp that also charges your phone. The desk upgrade you should have done years ago.', image_url: 'https://images.pexels.com/photos/4526407/pexels-photo-4526407.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 48000, revenue_growth_pct: 39, platforms: ['Amazon AU', 'TikTok Shop'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 't8', product_title: 'Bluetooth Tracker Tile Alternative', category: 'Tech & Gadgets', platform: 'Shopify', price_aud: 34, sold_count: 16300, winning_score: 73, trend: 'growing', competition_level: 'medium', au_relevance: 90, est_daily_revenue_aud: 1300, units_per_day: 38, why_winning: 'AirTag alternative at 1/3 price; anxiety-driven purchase with near-zero refund rate.', ad_angle: 'Find your keys, wallet, and bag. Every time. $34, works with Android and iPhone.', image_url: 'https://images.pexels.com/photos/1029757/pexels-photo-1029757.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 39000, revenue_growth_pct: 44, platforms: ['Shopify'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  // ── Pets ────────────────────────────────────────────────────────────────────
  { id: 'p1', product_title: 'Automatic Pet Feeder (Wi-Fi)', category: 'Pets', platform: 'Amazon AU', price_aud: 89, sold_count: 11200, winning_score: 82, trend: 'exploding', competition_level: 'low', au_relevance: 92, est_daily_revenue_aud: 2400, units_per_day: 27, why_winning: 'AU pet ownership at all-time high post-COVID. Wi-Fi feeders are the smart home pet must-have.', ad_angle: 'Feed your dog from Bali. Set schedules from your phone. Never miss a meal.', image_url: 'https://images.pexels.com/photos/1805164/pexels-photo-1805164.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 72000, revenue_growth_pct: 89, platforms: ['Amazon AU', 'Shopify'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'p2', product_title: 'Pet Stroller (Foldable 3-Wheeler)', category: 'Pets', platform: 'Amazon AU', price_aud: 149, sold_count: 4600, winning_score: 77, trend: 'growing', competition_level: 'low', au_relevance: 89, est_daily_revenue_aud: 1800, units_per_day: 12, why_winning: 'Senior pets + injured pets + dog parents who humanise their pets. Strong UGC.', ad_angle: 'Your old dog still wants to see the world. This costs $149 and changes everything.', image_url: 'https://images.pexels.com/photos/1805164/pexels-photo-1805164.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 54000, revenue_growth_pct: 64, platforms: ['Amazon AU'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'p3', product_title: 'Lick Mat Slow Feeder (Set of 3)', category: 'Pets', platform: 'TikTok Shop', price_aud: 28, sold_count: 19800, winning_score: 80, trend: 'exploding', competition_level: 'low', au_relevance: 94, est_daily_revenue_aud: 1500, units_per_day: 54, why_winning: 'Anxiety reduction in pets is the #1 pet trend in AU; these are satisfying to film.', ad_angle: 'Calm your anxious dog in 5 minutes. Vets recommend it. Filming it is optional.', image_url: 'https://images.pexels.com/photos/1805164/pexels-photo-1805164.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 45000, revenue_growth_pct: 156, platforms: ['TikTok Shop', 'Amazon AU'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'p4', product_title: 'Dog DNA Test Kit', category: 'Pets', platform: 'Shopify', price_aud: 89, sold_count: 6700, winning_score: 75, trend: 'growing', competition_level: 'medium', au_relevance: 88, est_daily_revenue_aud: 1500, units_per_day: 17, why_winning: 'Viral content format: "I found out my dog is 3% dingo." Every dog owner wants to know.', ad_angle: 'Find out exactly what breed your rescue dog is. Results in 2-3 weeks.', image_url: 'https://images.pexels.com/photos/1805164/pexels-photo-1805164.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 45000, revenue_growth_pct: 71, platforms: ['Shopify'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'p5', product_title: 'Cat Window Perch Suction (Large)', category: 'Pets', platform: 'Amazon AU', price_aud: 44, sold_count: 12300, winning_score: 71, trend: 'stable', competition_level: 'medium', au_relevance: 91, est_daily_revenue_aud: 1100, units_per_day: 25, why_winning: 'Cat entertainment is a real spend category; apartment cats need enrichment.', ad_angle: 'Give your indoor cat a window seat. Assembly in 30 seconds, holds up to 15kg.', image_url: 'https://images.pexels.com/photos/1805164/pexels-photo-1805164.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 33000, revenue_growth_pct: 22, platforms: ['Amazon AU', 'TikTok Shop'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  // ── Fashion & Accessories ──────────────────────────────────────────────────
  { id: 'fa1', product_title: 'Magnetic Closure Handbag (Mini)', category: 'Fashion & Accessories', platform: 'TikTok Shop', price_aud: 49, sold_count: 28600, winning_score: 81, trend: 'exploding', competition_level: 'medium', au_relevance: 87, est_daily_revenue_aud: 2200, units_per_day: 45, why_winning: 'Micro-bag trend dominating AU fashion TikTok; magnetic closure is the differentiator.', ad_angle: 'The bag that went viral for a reason. Fits everything that matters.', image_url: 'https://images.pexels.com/photos/1152077/pexels-photo-1152077.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 66000, revenue_growth_pct: 98, platforms: ['TikTok Shop'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'fa2', product_title: 'Stainless Steel Watch (Minimalist)', category: 'Fashion & Accessories', platform: 'Shopify', price_aud: 89, sold_count: 9400, winning_score: 78, trend: 'growing', competition_level: 'medium', au_relevance: 86, est_daily_revenue_aud: 1800, units_per_day: 20, why_winning: 'Quiet luxury trend driving demand for clean, simple watches at accessible prices.', ad_angle: 'The watch that costs $89 but looks like it cost $890. Everyone will ask where you got it.', image_url: 'https://images.pexels.com/photos/1152077/pexels-photo-1152077.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 54000, revenue_growth_pct: 55, platforms: ['Shopify', 'TikTok Shop'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'fa3', product_title: 'Silk Scrunchie Set (12pk)', category: 'Fashion & Accessories', platform: 'TikTok Shop', price_aud: 19, sold_count: 51300, winning_score: 71, trend: 'stable', competition_level: 'high', au_relevance: 93, est_daily_revenue_aud: 1300, units_per_day: 68, why_winning: 'Gift-ready, high repeat purchase, and silk positioning beats cotton at $5 more.', ad_angle: 'Stop breaking your hair. Silk scrunchies, $19 for 12. The upgrade is obvious.', image_url: 'https://images.pexels.com/photos/3762875/pexels-photo-3762875.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 39000, revenue_growth_pct: 16, platforms: ['TikTok Shop', 'Amazon AU'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: 'fa4', product_title: 'Crossbody Phone Bag (Card Holder)', category: 'Fashion & Accessories', platform: 'TikTok Shop', price_aud: 34, sold_count: 22100, winning_score: 76, trend: 'growing', competition_level: 'medium', au_relevance: 90, est_daily_revenue_aud: 1400, units_per_day: 41, why_winning: 'Hands-free festival/event accessory; AU summer = massive Q4/Q1 opportunity.', ad_angle: 'Phone + cards + keys. Crossbody. Both hands free. Summer sorted.', image_url: 'https://images.pexels.com/photos/1152077/pexels-photo-1152077.jpeg?auto=compress&cs=tinysrgb&w=400', tiktok_product_url: null, est_monthly_revenue_aud: 42000, revenue_growth_pct: 48, platforms: ['TikTok Shop'], scraped_at: new Date().toISOString(), updated_at: new Date().toISOString() },
        ...
        <div
          ...
          style={{
            background: s.highlight
              ? 'linear-gradient(135deg, rgba(59,130,246,0.15) 0%, rgba(59,130,246,0.04) 100%)'
              : C.glass,
        ...
        >
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
              ...
              <button
                onClick={() => {
                  const p = new URLSearchParams({ productName: product.product_title || '', niche: product.category || '', price: String(product.price_aud || 49), imageUrl: product.image_url || '', fromDatabase: 'true' });
                  window.location.href = `/app/store-builder?${p}`;
                }}
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: hovered ? '0 0 24px rgba(59,130,246,0.08)' : 'none',
        position: 'relative',
      }}
    >
      {/* Image */}
          ...
          <div style={{ display: 'flex', gap: 6 }}>
            ...
            {onToggleCompare && (
              <button
                ...
                style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 5, padding: '7px 10px', borderRadius: 9, background: inCompare ? 'rgba(59,130,246,0.12)' : C.glass, border: `1px solid ${inCompare ? C.goldBorder : C.border}`, color: inCompare ? C.gold : C.sub, fontSize: 11, fontWeight: 700, cursor: 'pointer', whiteSpace: 'nowrap' }}
              >
              ...
              <div style={{ marginTop: 16 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
                  ...
                  <div style={{ display: 'flex', gap: 4 }}>
                    {['TikTok Shop', 'AliExpress', 'Alibaba', 'Amazon AU'].map((src) => (
                      <span key={src} style={{ fontSize: 10, fontWeight: 700, padding: '2px 7px', borderRadius: 10, background: 'rgba(59,130,246,0.12)', color: C.gold, border: `1px solid ${C.goldBorder}` }}>
                ...
                {searchResults.length === 0 ? (
                  <div style={{ padding: '40px 24px', background: C.glass, border: `1px solid ${C.border}`, borderRadius: 14, textAlign: 'center' }}>
                    ...
                    <button onClick={() => setSearchResults(null)} style={{ background: 'rgba(59,130,246,0.12)', border: '1px solid rgba(59,130,246,0.3)', color: '#3B82F6', borderRadius: 8, padding: '8px 16px', fontSize: 12, fontWeight: 700, cursor: 'pointer', fontFamily: "'Bricolage Grotesque', sans-serif" }}>
                      ← Clear Search
                    </button>
                  </div>
                ) : (
                    ...
                    if (!isPro) {
                      toast(
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                          ...
                          <button
                            onClick={() => window.location.assign('/pricing')}
                            style={{ background: '#3B82F6', color: '#000', border: 'none', borderRadius: 8, padding: '6px 14px', fontSize: 12, fontWeight: 700, cursor: 'pointer', alignSelf: 'flex-start' }}
                          >
                            Upgrade Now →
                          </button>
                        </div>,
      ...
      {compareIds.size >= 2 && !showCompare && (
        <div
          style={{
            ...
            zIndex: 990,
            background: 'linear-gradient(135deg, rgba(59,130,246,0.1), #111114)',
            border: `1px solid ${C.goldBorder}`,
            borderRadius: 16,
            padding: '14px 24px',
            display: 'flex',
            alignItems: 'center',
            gap: 16,
            boxShadow: '0 8px 32px rgba(0,0,0,0.1), 0 0 40px rgba(59,130,246,0.08)',
          }}
        >
