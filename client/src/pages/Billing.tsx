    ...
    <div className="billing-page" style={{ padding: '32px 24px', maxWidth: 640, margin: '0 auto', fontFamily: 'DM Sans, sans-serif' }}>
      ...
      {loading ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          {/* Current Plan Card */}
          <div style={{ background: C.card, border: `1px solid ${isActive ? 'rgba(79,142,247,0.25)' : C.border}`, borderRadius: 16, padding: 24 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
              <div style={{ width: 40, height: 40, borderRadius: 10, background: isActive ? 'rgba(79,142,247,0.15)' : C.surface, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              {isActive && (
                <span style={{ marginLeft: 'auto', fontSize: 11, fontWeight: 700, padding: '4px 10px', borderRadius: 6, background: 'rgba(79,142,247,0.12)', color: C.gold, fontFamily: "'Syne', sans-serif" }}>
                  SUBSCRIBED
                </span>
              )}
            </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            ...
            {planLabel === 'Free' && (
              <a
                href="/pricing"
                style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, padding: '12px 20px', background: '#4f8ef7', color: 'white', borderRadius: 10, fontSize: 14, fontWeight: 800, cursor: 'pointer', textDecoration: 'none', fontFamily: "'Syne', sans-serif" }}
              >
            ...
            {planLabel === 'Builder' && (
              <a
                href="/pricing"
                style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, padding: '12px 20px', background: C.surface, border: '1px solid rgba(79,142,247,0.3)', color: C.gold, borderRadius: 10, fontSize: 14, fontWeight: 700, cursor: 'pointer', textDecoration: 'none', fontFamily: "'Syne', sans-serif" }}
              >
