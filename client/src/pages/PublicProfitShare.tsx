    ...
    return (
      <div style={{ minHeight: '100vh', background: '#0A0A0F', color: '#F0EDE8', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: dm }}>
        <div style={{ textAlign: 'center' as const }}>
          ...
          <a href="https://www.majorka.io/tools/profit-calculator" style={{ color: '#3B82F6', fontWeight: 600, fontSize: 14, textDecoration: 'none' }}>
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0A0A0F', color: '#F0EDE8', fontFamily: dm }}>
      ...
      <div style={{ padding: '16px 24px', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        <a href="https://www.majorka.io" style={{ fontFamily: brico, fontWeight: 800, fontSize: 18, color: '#3B82F6', textDecoration: 'none' }}>
          Majorka
        </a>
      </div>
      ...
      <div style={{ maxWidth: 520, margin: '40px auto', padding: '0 20px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 24 }}>
          {[
            ...
            { label: 'Break-even CPA', value: fmtAUD(breakEvenCPA), color: '#3B82F6' },
        ...
        <div style={{ textAlign: 'center' as const }}>
          <a href="https://www.majorka.io/tools/profit-calculator"
            style={{ display: 'inline-block', padding: '14px 28px', background: '#3B82F6', color: 'white', borderRadius: 10, fontSize: 14, fontWeight: 700, fontFamily: brico, textDecoration: 'none', transition: 'transform 150ms' }}>
            Calculate profit for your own products →
          </a>
          <div style={{ marginTop: 12, fontSize: 12, color: '#94A3B8' }}>
            Powered by <a href="https://www.majorka.io" style={{ color: '#3B82F6', textDecoration: 'none' }}>Majorka</a>
          </div>
        </div>
      </div>
    </div>
