...
export default function Affiliate() {
  ...
  return (
    <div
      style={{ minHeight: '100vh', background: C.bg, padding: '40px 24px 80px', fontFamily: dm }}
    >
      <div style={{ maxWidth: 900, margin: '0 auto' }}>
        ...
        {!stats?.joined ? (
          ...
          <div style={{ ...cardStyle, textAlign: 'center', padding: 48 }}>
            ...
            >
              Share Majorka with other AU sellers and earn 30% recurring commission on every
              subscription. No cap. No expiry. Paid monthly via PayPal or bank transfer.
            </p>
            ...
            >
              {[
                ...
                >
                  <div style={{ fontFamily: syne, fontSize: 24, fontWeight: 800, color: C.gold }}>
                    {item.value}
                  </div>
            ...
            >
              {[
                ...
                },
                {
                  icon: TrendingUp,
                  label: 'Commission',
                  value: `${stats.commissionRate ?? 30}%`,
                  color: '#a855f7',
                },
              ].map((stat) => (
                <div key={stat.label} style={cardStyle}>
                  <stat.icon size={20} color={stat.color} style={{ marginBottom: 8 }} />
                  <div style={{ fontFamily: syne, fontSize: 28, fontWeight: 800, color: C.text }}>
                    {stat.value}
                  </div>
