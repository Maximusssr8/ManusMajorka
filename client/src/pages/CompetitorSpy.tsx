              ...
              if (match) {
                return (
                  <div key={j} className="flex gap-2 text-sm" style={{ color: '#F1F5F9', fontFamily: 'DM Sans, sans-serif' }}>
                    ...
                    <span>
                      <span className="font-semibold" style={{ color: '#3B82F6' }}>{match[1]}</span>
        ...
        <div className="flex-1 min-w-0 p-6">
          ...
          {loading && (
            ...
            >
              ...
              <p className="text-sm font-medium mb-2" style={{ color: '#F1F5F9' }}>Researching: <span style={{ color: '#3B82F6' }}>"{query}"</span></p>
                ...
                {PROGRESS_STEPS.map((step, i) => (
                  <div key={step} className="flex items-center gap-3">
                    <div
                      ...
                      style={{
                        background: i <= progressStep ? 'rgba(59,130,246,0.2)' : 'rgba(255,255,255,0.05)',
                        border: `1px solid ${i <= progressStep ? 'rgba(59,130,246,0.4)' : 'rgba(255,255,255,0.08)'}`,
                      }}
                    >
                      {i < progressStep ? '✓' : i === progressStep ? <Loader2 size={10} className="animate-spin" style={{ color: '#3B82F6' }} /> : ''}
                    </div>
