    ...
    tools: [
      {
        ...
        desc: 'AI scans global marketplaces to surface winning products with real AU demand, low competition, and healthy margins.',
      },
      {
        emoji: '🔑',
        title: 'Keyword Miner',
        desc: 'Extract high-converting search terms from Amazon AU, Google, and TikTok. Rank your listings from day one.',
      },
      {
        emoji: '📊',
        title: 'Saturation Checker',
        desc: 'Know before you sell if a niche is already dead. Scores competition on a 0–100 index across 5 platforms.',
      },
      {
        emoji: '🏭',
        title: 'Supplier Finder',
        desc: 'Verified supplier matches from Alibaba, AliExpress, CJ, and AU-based warehouses — with landed cost to your door.',
      },
      {
        emoji: '🎯',
        title: 'Audience Profiler',
        desc: 'Laser-precise buyer personas for AU, UK, and US markets. Feed directly into Meta and TikTok targeting.',
      },
    ],
  },
  {
    ...
    tools: [
      {
        ...
        desc: 'Full Shopify-ready store pages — hero, product, collection. Exports Liquid theme files, production-ready in minutes.',
      },
      {
        emoji: '✍️',
        title: 'Copywriter',
        desc: 'Conversion-optimised product descriptions, taglines, and homepage copy in your brand voice. AU English by default.',
      },
      {
        emoji: '📧',
        title: 'Email Sequences',
        desc: '5-email welcome flows, abandon cart, and post-purchase sequences tuned for AU consumer psychology.',
      },
      {
        emoji: '🎨',
        title: 'Brand DNA',
        desc: 'Full brand identity: name, colour palette, voice guide, and taglines — calibrated for your niche in 60 seconds.',
      },
      {
        emoji: '🎬',
        title: 'Ads Studio',
        desc: 'Multi-platform ad creative briefs with hooks, scripts, and visual direction for Meta and TikTok AU.',
      },
      {
        emoji: '📱',
        title: 'Meta Ads Pack',
        desc: '5 complete ad angles with AU audience targeting and compliant copy — ready to upload to Ads Manager.',
      },
      {
        emoji: '🎵',
        title: 'TikTok Builder',
        desc: 'Viral TikTok scripts, trending audio suggestions, and content calendars aligned with AU peak seasons.',
      },
    ],
  },
  {
    ...
    tools: [
      {
        emoji: '✅',
        title: 'Validate',
        desc: 'AI-scores your product on 12 dimensions: demand, margin, competition, trend, and compliance. Know before you spend.',
      },
      {
        emoji: '🚀',
        title: 'Scaling Playbook',
        desc: 'Structured 30-60-90 day scaling plan with ad budget allocations, SKU expansion triggers, and milestone targets.',
      },
      {
        emoji: '💬',
        title: 'AI Chat',
        desc: 'Always-on AI advisor that knows your products, niche, and market. Ask anything — get answers that apply to you.',
      },
      {
        emoji: '📚',
        title: 'Knowledge Base',
        desc: 'Searchable library of AU ecommerce guides, compliance checklists, and supplier playbooks. Built by operators.',
      },
    ],
  },
];
    ...
    return (
      ...
      >
        ...
        <p style={{ color: C.secondary, fontSize: 15, lineHeight: 1.6 }}>
          While you wait,{' '}
          <Link href="/app" style={{ color: C.gold, textDecoration: 'underline' }}>
            try the tools free →
          </Link>
        </p>
      </div>
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        boxShadow: hovered ? '0 20px 40px rgba(0,0,0,0.4), 0 0 0 1px rgba(212,175,55,0.1)' : 'none',
      ...
      >
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <span
              style={{ fontFamily: syne, fontWeight: 800, fontSize: 17, letterSpacing: '0.08em' }}
            >
              MAJORKA
            </span>
          </div>
          ...
          <div className="hide-mobile" style={{ display: 'flex', alignItems: 'center', gap: 32 }}>
            ...
            <Link
              href="/sign-in"
              style={{ color: C.secondary, textDecoration: 'none', fontSize: 14, fontWeight: 500 }}
            >
              Sign In
            </Link>
          </div>
      ...
      >
        ...
        <div
          style={{
            ...
            marginLeft: -450,
            background:
              'conic-gradient(from 0deg, transparent, rgba(212,175,55,0.025), transparent, rgba(212,175,55,0.015), transparent, rgba(212,175,55,0.02), transparent)',
        ...
        >
          ...
          <div style={{ flex: '1 1 380px', minWidth: 0 }}>
            ...
            >
              ...
              />
              <span
                style={{ fontSize: 12, fontWeight: 600, color: C.gold, letterSpacing: '0.03em' }}
              >
            ...
            >
              20+ AI tools for product research, store building, ads, and scaling. One platform.
      ...
      <section id="features" style={{ padding: '100px 24px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          {PHASE_FEATURES.map((phase, phaseIdx) => (
            <div
              key={phaseIdx}
              style={{ marginBottom: phaseIdx < PHASE_FEATURES.length - 1 ? 72 : 0 }}
            >
              {/* Phase header */}
              <motion.div
                variants={fadeUp}
              ...
              >
                {phase.tools.map((tool, toolIdx) => (
                  <FeatureCard key={toolIdx} tool={tool} index={toolIdx} phaseColor={phase.color} />
                ))}
              </div>
            </div>
          ))}
        ...
        <div style={{ position: 'relative' }}>
          <div
            style={{
              ...
              bottom: 0,
              width: 100,
              background: `linear-gradient(to right, ${C.card}, transparent)`,
              zIndex: 1,
              pointerEvents: 'none',
            }}
          />
          <div
            style={{
              ...
              bottom: 0,
              width: 100,
              background: `linear-gradient(to left, ${C.card}, transparent)`,
              zIndex: 1,
              pointerEvents: 'none',
            }}
          />
            ...
            <div style={{ minWidth: 480 }}>
              ...
              {COMPARISON_ROWS.map((row, i) => (
                ...
                >
                  ...
                  <span
                    style={{ textAlign: 'center', fontSize: 16, color: C.green, fontWeight: 700 }}
                  >
                    ✓
                  </span>
                  <span
              ...
              >
                <span style={{ fontFamily: syne, fontWeight: 900, fontSize: 15, color: C.text }}>
                  Monthly Cost
                </span>
                <span
                  style={{
            ...
            {isAU && (
              ...
              >
                ...
                <span style={{ fontSize: 12, color: C.gold, fontWeight: 600 }}>
                  Prices in AUD · Afterpay & Zip available
                </span>
              </div>
            )}
            {isUK && (
              ...
              >
                <span>🇬🇧</span>
                <span style={{ fontSize: 12, color: C.gold, fontWeight: 600 }}>
                  Prices in GBP · Klarna available
                </span>
              </div>
            )}
            {isEU && !isUK && (
              ...
              >
                <span>🇪🇺</span>
                <span style={{ fontSize: 12, color: C.gold, fontWeight: 600 }}>
                  Prices in EUR · Klarna available
                </span>
              </div>
            )}
          </motion.div>
            ...
            {PRICING.map((plan, i) => (
              ...
              >
                ...
                <div style={{ display: 'flex', alignItems: 'baseline', gap: 4, marginBottom: 24 }}>
                  <span style={{ fontFamily: syne, fontWeight: 900, fontSize: 44, color: C.text }}>
                    {plan.price}
                  </span>
                ...
                <Link
                  ...
                  style={{
                    ...
                    background: plan.highlight
                      ? `linear-gradient(135deg, ${C.gold}, #b8941f)`
                ...
                >
                  {plan.features.map((f) => (
                    ...
                    >
                      <span
                        style={{ color: C.green, fontWeight: 700, fontSize: 12, flexShrink: 0 }}
                      >
                        ✓
                      </span>{' '}
                      {f}
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          >
            ...
            <p style={{ color: C.secondary, fontSize: 17, maxWidth: 500, margin: '0 auto' }}>
              Get our product research playbook and weekly trending products — straight to your
              inbox.
            </p>
          </motion.div>
          <EmailCapture />
      ...
      <footer style={{ background: C.card, position: 'relative' }}>
        ...
        <div
          style={{
            height: 1,
            background:
              'linear-gradient(to right, transparent, rgba(212,175,55,0.35) 30%, rgba(212,175,55,0.6) 50%, rgba(212,175,55,0.35) 70%, transparent)',
          }}
        />
          ...
          >
            ...
            <div style={{ maxWidth: 280 }}>
              ...
              <p style={{ color: C.muted, fontSize: 13, lineHeight: 1.65, marginBottom: 16 }}>
                The AI Ecommerce Operating System built for serious sellers worldwide. From idea to
                income.
              </p>
              <div
                style={{
              ...
              <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                <a
                  href="https://twitter.com/majorkaai"
                  target="_blank"
                ...
                <a
                  href="https://instagram.com/majorkaai"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="social-icon-btn"
                  title="Instagram"
                ...
                <a
                  href="https://tiktok.com/@majorkaai"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="social-icon-btn"
                  title="TikTok"
            ...
            <div style={{ display: 'flex', gap: 48, flexWrap: 'wrap' }}>
              <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                  ...
                  <a href="#demo" style={{ color: C.muted, textDecoration: 'none', fontSize: 13 }}>
                    Demo
                  </a>
                  <a href="#faq" style={{ color: C.muted, textDecoration: 'none', fontSize: 13 }}>
                    FAQ
                  </a>
                </div>
              </div>
              ...
              <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                  ...
                  <a href="/terms" style={{ color: C.muted, textDecoration: 'none', fontSize: 13 }}>
                    Terms of Service
                  </a>
                  <a
                    href="/refund-policy"
