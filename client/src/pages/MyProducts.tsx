...
const statusColors: Record<string, { bg: string; text: string; label: string }> = {
  ...
  build: { bg: 'rgba(59,130,246,0.12)', text: '#3B82F6', label: 'Build' },
  launch: { bg: 'rgba(255,100,100,0.12)', text: '#ff6b6b', label: 'Launch' },
  optimize: { bg: 'rgba(59,130,246,0.18)', text: '#3B82F6', label: 'Optimize' },
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              style={{
                background: sortByScore ? 'rgba(59,130,246,0.12)' : '#F9FAFB',
                border: `1px solid ${sortByScore ? 'rgba(59,130,246,0.4)' : '#F5F5F5'}`,
                color: sortByScore ? '#3B82F6' : '#6B7280',
                cursor: 'pointer',
              }}
            >
