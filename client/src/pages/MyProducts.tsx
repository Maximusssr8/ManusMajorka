...
const statusColors: Record<string, { bg: string; text: string; label: string }> = {
  ...
  build: { bg: 'rgba(79,142,247,0.12)', text: '#4f8ef7', label: 'Build' },
  launch: { bg: 'rgba(255,100,100,0.12)', text: '#ff6b6b', label: 'Launch' },
  optimize: { bg: 'rgba(79,142,247,0.18)', text: '#4f8ef7', label: 'Optimize' },
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              style={{
                background: sortByScore ? 'rgba(79,142,247,0.12)' : '#F9FAFB',
                border: `1px solid ${sortByScore ? 'rgba(79,142,247,0.4)' : '#F5F5F5'}`,
                color: sortByScore ? '#4f8ef7' : '#6B7280',
                cursor: 'pointer',
              }}
            >
              ...
              {importedProduct && (
                ...
                >
                  <div className="flex items-center gap-2 mb-3">
                    <Check size={14} style={{ color: '#4f8ef7' }} />
                    <div
                  ...
                  <div className="mb-2">
                    ...
                    {importedProduct.price && (
                      <div className="text-xs font-bold" style={{ color: '#4f8ef7' }}>
                        {importedProduct.price}
                      </div>
                    )}
                  </div>
