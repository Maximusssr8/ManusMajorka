...
const COLORS = ["#d4af37", "#9c5fff", "#2dca72", "#ff6b6b", "#4ecdc4", "#ffa500", "#e91e63", "#00bcd4"];
    ...
    <div className="flex h-[calc(100vh-64px)]" style={{ background: "#080a0e" }}>
      ...
      >
        ...
        <div className="p-5 space-y-5 flex-1">
          <div>
            <label className="text-xs font-bold uppercase tracking-widest mb-2 block" style={{ color: "rgba(240,237,232,0.5)", fontFamily: "Syne, sans-serif" }}>
              Niche / Market *
            </label>
            <Input
              value={niche}
              ...
              className="text-sm"
              style={{ background: "rgba(255,255,255,0.04)", borderColor: "rgba(255,255,255,0.1)", color: "#f0ede8" }}
            />
          </div>
          ...
          <div>
            ...
            <Textarea
              ...
              style={{ background: "rgba(255,255,255,0.04)", borderColor: "rgba(255,255,255,0.1)", color: "#f0ede8" }}
            />
            <p className="text-xs mt-1" style={{ color: "rgba(240,237,232,0.3)" }}>One per line. Leave blank to auto-discover.</p>
          </div>
          ...
          <Button
            ...
            style={{
              background: loading ? "rgba(212,175,55,0.3)" : "linear-gradient(135deg, #d4af37, #c09a28)",
              color: "#080a0e",
          ...
          {!mapData && !loading && (
            <div className="space-y-2">
              <p className="text-xs font-bold uppercase tracking-widest" style={{ color: "rgba(240,237,232,0.3)", fontFamily: "Syne, sans-serif" }}>
                Try these
              </p>
        ...
        {!mapData && !loading && (
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-sm font-bold mb-1" style={{ fontFamily: "Syne, sans-serif", color: "rgba(240,237,232,0.5)" }}>
        ...
        {loading && (
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-sm" style={{ color: "rgba(240,237,232,0.5)" }}>Researching market positioning…</p>
            </div>
          </div>
        )}
          ...
          <div className="flex-1 overflow-y-auto p-6">
            <div className="max-w-4xl mx-auto space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-lg font-black" style={{ fontFamily: "Syne, sans-serif", color: "#f0ede8" }}>
              ...
              >
                ...
                <div className="absolute inset-0 pointer-events-none">
                  {/* X axis label */}
                  <div className="absolute bottom-2 left-1/2 -translate-x-1/2 text-xs font-bold uppercase tracking-widest" style={{ color: "rgba(240,237,232,0.3)", fontFamily: "Syne, sans-serif" }}>
                    Price →
                  </div>
                  {/* Y axis label */}
                  <div
                  ...
                  {/* Quadrant labels */}
                  <div className="absolute top-3 left-8 text-xs" style={{ color: "rgba(255,255,255,0.12)", fontFamily: "Syne, sans-serif" }}>Budget / High Quality</div>
                  <div className="absolute top-3 right-4 text-xs" style={{ color: "rgba(255,255,255,0.12)", fontFamily: "Syne, sans-serif" }}>Premium</div>
                  <div className="absolute bottom-8 left-8 text-xs" style={{ color: "rgba(255,255,255,0.12)", fontFamily: "Syne, sans-serif" }}>Budget</div>
                  <div className="absolute bottom-8 right-4 text-xs" style={{ color: "rgba(255,255,255,0.12)", fontFamily: "Syne, sans-serif" }}>Expensive / Low Quality</div>
                  {/* Center lines */}
                  <div className="absolute top-0 bottom-0 left-1/2 border-l" style={{ borderColor: "rgba(255,255,255,0.06)" }} />
                  <div className="absolute left-0 right-0 top-1/2 border-t" style={{ borderColor: "rgba(255,255,255,0.06)" }} />
                </div>
                ...
                {mapData.competitors.map((c, i) => (
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{ background: "rgba(0,0,0,0.9)", color: "#f0ede8", border: `1px solid ${c.color}40` }}
                    >
                ...
                {mapData.yourBrand && (
                  ...
                  >
                    ...
                    <div
                      className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-2 py-1 rounded-lg text-xs whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-10"
                      style={{ background: "rgba(0,0,0,0.9)", color: "#f0ede8", border: "1px solid rgba(255,255,255,0.3)" }}
                    >
              ...
              <div className="flex flex-wrap gap-3">
                ...
                {mapData.yourBrand && (
                  <div className="flex items-center gap-2 text-xs">
                    <div className="w-3 h-3 rounded-full border flex-shrink-0" style={{ borderColor: "#ffffff", background: "rgba(255,255,255,0.1)" }} />
                    <span style={{ color: "#ffffff" }}>You ({mapData.yourBrand.name})</span>
                  </div>
                )}
                <div className="flex items-center gap-2 text-xs">
                  <div className="w-3 h-3 rounded-full border border-dashed flex-shrink-0" style={{ borderColor: "#2dca72" }} />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div
                  ...
                  style={{ background: "rgba(45,202,114,0.04)", borderColor: "rgba(45,202,114,0.2)" }}
                >
                  <h3 className="text-xs font-black uppercase tracking-widest mb-3" style={{ color: "#2dca72", fontFamily: "Syne, sans-serif" }}>
                    Opportunity Zone
                  </h3>
                  <p className="text-sm" style={{ color: "rgba(240,237,232,0.8)" }}>{mapData.opportunityZone}</p>
                  {mapData.recommendedPosition && (
                    <div className="mt-3 px-3 py-1.5 rounded-lg inline-block text-xs font-bold" style={{ background: "rgba(45,202,114,0.12)", color: "#2dca72" }}>
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    <h3 className="text-xs font-black uppercase tracking-widest" style={{ color: "rgba(240,237,232,0.5)", fontFamily: "Syne, sans-serif" }}>
                      Key Insights
                    </h3>
                    <button
                      onClick={() => {
                  ...
                  <ul className="space-y-2">
                    {mapData.insights.map((ins, i) => (
                      <li key={i} className="flex items-start gap-2 text-xs" style={{ color: "rgba(240,237,232,0.7)" }}>
              ...
              {/* Competitor details */}
              <div>
                <h3 className="text-xs font-black uppercase tracking-widest mb-3" style={{ color: "rgba(240,237,232,0.5)", fontFamily: "Syne, sans-serif" }}>
                  Competitor Details
                </h3>
                  ...
                  {mapData.competitors.map((c, i) => (
                    ...
                    >
                      <div className="flex items-center gap-2 mb-2">
                        <div className="w-5 h-5 rounded-full flex items-center justify-center text-xs font-black" style={{ background: c.color, color: "#080a0e" }}>
                          {c.name.charAt(0)}
                        </div>
                        <span className="text-sm font-bold" style={{ fontFamily: "Syne, sans-serif", color: "#f0ede8" }}>{c.name}</span>
                      </div>
                      <p className="text-xs mb-2" style={{ color: "rgba(240,237,232,0.6)" }}>{c.description}</p>
                      <div className="flex gap-3 text-xs">
                        <span style={{ color: "rgba(240,237,232,0.4)" }}>Price: <strong style={{ color: c.color }}>{c.price}/10</strong></span>
                        <span style={{ color: "rgba(240,237,232,0.4)" }}>Quality: <strong style={{ color: c.color }}>{c.quality}/10</strong></span>
                      </div>
                    </div>
                  ))}
                </div>
