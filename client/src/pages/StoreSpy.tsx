...
function md(text: string): string {
  return text
    ...
    // ### H3
    .replace(/^### (.+)$/gm, '<h3 style="font-family:Syne,sans-serif;font-size:16px;font-weight:600;color:#d4af37;margin:16px 0 8px">$1</h3>')
...
const FEATURES = [
  {
    ...
    description:
      "See their full product catalogue, price ranges, and bestsellers at a glance.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Detect signs of paid traffic, retargeting pixels, and active campaign patterns.",
  },
  {
    title: "Gaps & Opportunities",
    description:
      "AI-identified weaknesses you can exploit and market angles they're missing.",
  },
  {
    title: "AU-Specific Insights",
    description:
      "Shipping, payment methods, and positioning evaluated for the Australian market.",
  },
  {
    ...
    <div style={pageStyle}>
      <div style={containerStyle}>
        ...
        <div style={{ marginBottom: 40, textAlign: "center" }}>
          ...
          >
            Enter any Shopify store URL to get a full competitor intelligence
            report
          </p>
        </div>
